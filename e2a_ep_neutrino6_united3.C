#define e2a_ep_neutrino6_united3_cxx
#include "e2a_ep_neutrino6_united3.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
void prot1_pi1_rot_func(TVector3 V3q, TVector3  V3prot,TVector3 V3pi, int q_pi, double *N_pi_p,double *N_nopi_p);
void pi1_rot_func(TVector3 V3_pi, int q_pi, TVector3 V3_q,double *P_pi);
void pi2_rot_func(TVector3 V3_pi[2], int q_pi[2], TVector3 V3_q,double *P_0pi,double P_1pi[2]);
void pi3_rot_func(TVector3 V3_pi[3], int q_pi[3], TVector3 V3_q,double *P_0pi,double P_1pi[3],double P_320[3],double P_3210[][2]);
...
void e2a_ep_neutrino6_united3::Loop()
{
...
if (fChain == 0) return;
  ...
  double N_prot1=0,N_prot2=0,N_prot_both=0,N_tot=100; 
  double eps=0.02;//GeV
 ...
 double prot_accept_mom_lim;
  ...
  double min_good_mom;
  double max_mom;
  Double_t el_sccc_timediff, sc_cc_delt_cut_sect[nsect]={-2,-5,-8,-8,-2,2}, el_cc_nphe;
...
EC_photon_beta["3He"]=0.92;
 ...
 EC_time_offset[std::make_pair("56Fe",4)]=-0.25;  EC_time_offset[std::make_pair("56Fe",5)]=-0.17; EC_time_offset[std::make_pair("56Fe",6)]=-0.35;
  ...
  bind_en["3He"]=He3_bind_en-D2_bind_en;
  bind_en["4He"]=He4_bind_en-H3_bind_en;
  bind_en["C12"]=C12_bind_en-B_bind_en;
  bind_en["56Fe"]=Fe_bind_en-Mn_bind_en;
 ...
 TH1F *h1_el_ec_sc_timediff_sect_corr[nsect], *h1_el_ec_sc_timediff_sect[nsect],*h1_beta_ec_corr_sect[nsect];
  ...
  TFile *file_in6 = new TFile("vz_3He_2261_2ndrungroup.root");//vertex correction for 3He 2nd group runs 
  TFile *file_in7 = new TFile("vz_4He_2261_2ndrungroup.root");//vertex correction for 4He 2nd group runs
  TFile *file_out = new TFile(Form("e2a_ep_%s_%s_neutrino6_united3.root",ftarget.c_str(),fbeam_en.c_str()), "Recreate");
  // TFile *file_out = new TFile(Form("/volatile/clas/clase2/Mariana/Skim_Mariana/e2a_ep_%s_%s_neutrino6_united2_skim.root",ftarget.c_str(),fbeam_en.c_str()), "Recreate");
...
TH1F *h1_E_rec_1pi_weight_frac_feed=new TH1F("h1_E_rec_1pi_weight_frac_feed","",300,-1,0.4);
TH1F *h1_E_rec_2pi_weight_frac_feed=new TH1F("h1_E_rec_2pi_weight_frac_feed","",300,-1,0.4);
TH1F *h1_E_rec_3pi_weight_frac_feed=new TH1F("h1_E_rec_3pi_weight_frac_feed","",300,-1,0.4);
TH1F *h1_E_rec_0pi_frac_feed=new TH1F("h1_E_rec_0pi_frac_feed","",300,-1,0.4);
 TH1F *h1_E_tot_cut2_fracfeed = new TH1F("h1_E_tot_cut2_fracfeed","",300,-1,0.4);
TH1F *h1_E_rec_cut2_new_fracfeed = new TH1F("h1_E_rec_cut2_new_fracfeed","",300,-1,0.4);
TH1F *Etot_p_bkgd_fracfeed = new TH1F("Etot_p_bkgd_fracfeed","",300,-1,0.4);
TH1F *Erec_p_bkgd_fracfeed = new TH1F("Erec_p_bkgd_fracfeed","",300,-1,0.4);
TH1F *Etot_2p1pi_2p0pi_fracfeed = new TH1F("Etot_2p1pi_2p0pi_fracfeed","",300,-1,0.4);
TH1F *Erec_2p1pi_2p0pi_fracfeed = new TH1F("Erec_2p1pi_2p0pi_fracfeed","",300,-1,0.4);
TH1F *Etot_2p1pi_1p1pi_fracfeed = new TH1F("Etot_2p1pi_1p1pi_fracfeed","",300,-1,0.4);
TH1F *Erec_2p1pi_1p1pi_fracfeed = new TH1F("Erec_2p1pi_1p1pi_fracfeed","",300,-1,0.4);
TH1F *Etot_2p1pi_1p0pi_fracfeed = new TH1F("Etot_2p1pi_1p0pi_fracfeed","",300,-1,0.4);
TH1F *Erec_2p1pi_1p0pi_fracfeed = new TH1F("Erec_2p1pi_1p0pi_fracfeed","",300,-1,0.4);
TH1F *Etot_3pto2p_fracfeed = new TH1F("Etot_3pto2p_fracfeed","",300,-1,0.4);
TH1F *Erec_3pto2p_fracfeed = new TH1F("Erec_3pto2p_fracfeed","",300,-1,0.4);
TH1F *Etot_3pto1p_fracfeed = new TH1F("Etot_3pto1p_fracfeed","",300,-1,0.4);
TH1F *Erec_3pto1p_fracfeed = new TH1F("Erec_3pto1p_fracfeed","",300,-1,0.4);
TH1F *Etot_4pto3p_fracfeed = new TH1F("Etot_4pto3p_fracfeed","",300,-1,0.4);
TH1F *Erec_4pto3p_fracfeed = new TH1F("Erec_4pto3p_fracfeed","",300,-1,0.4);
TH1F *Etot_43pto1p_fracfeed = new TH1F("Etot_43pto1p_fracfeed","",300,-1,0.4);
TH1F *Erec_43pto1p_fracfeed = new TH1F("Erec_43pto1p_fracfeed","",300,-1,0.4);
TH1F *Etot_4pto2p_fracfeed = new TH1F("Etot_4pto2p_fracfeed","",300,-1,0.4);
TH1F *Erec_4pto2p_fracfeed = new TH1F("Erec_4pto2p_fracfeed","",300,-1,0.4);
TH1F *Etot_4pto1p_fracfeed = new TH1F("Etot_4pto1p_fracfeed","",300,-1,0.4);
TH1F *Erec_4pto1p_fracfeed = new TH1F("Erec_4pto1p_fracfeed","",300,-1,0.4);
TH1F *Etot_1p2pi_fracfeed = new TH1F("Etot_1p2pi_fracfeed","",300,-1,0.4);
TH1F *Erec_1p2pi_fracfeed = new TH1F("Erec_1p2pi_fracfeed","",300,-1,0.4);
TH1F *Etot_1p2pi_1p0pi_fracfeed = new TH1F("Etot_1p2pi_1p0pi_fracfeed","",300,-1,0.4);
TH1F *Erec_1p2pi_1p0pi_fracfeed = new TH1F("Erec_1p2pi_1p0pi_fracfeed","",300,-1,0.4);
TH1F *h1_E_rec_undetfactor_fracfeed = new TH1F("h1_E_rec_undetfactor_fracfeed","",300,-1,0.4);
TH1F *h1_E_tot_undetfactor_fracfeed = new TH1F("h1_E_tot_undetfactor_fracfeed","",300,-1,0.4);
...
TH2F *h2_el_E_p_ratio = new TH2F("h2_el_E_p_ratio","",200,0,4.5,200,0,0.5);
 ...
 TH2F *h2_pipl_theta_phi_p = new TH2F("h2_pipl_theta_phi_p","",200,0,360,200,0,180);
  TH2F *h2_pipl_theta_phi_p_fidcut = new TH2F("h2_pipl_theta_phi_p_fidcut","",200,0,360,200,0,180);
 TH2F *h2_pimi_theta_phi_p = new TH2F("h2_pimi_theta_phi_p","",200,0,360,200,0,180);
  TH2F *h2_pimi_theta_phi_p_fidcut = new TH2F("h2_pimi_theta_phi_p_fidcut","",200,0,360,200,0,180);
...
Etot_4pto1p->Sumw2();
 ...
 if( ec[ind_em] < 0.5 ||  sc[ind_em] < 0.5 ||  cc[ind_em] < 0.5 || q[ind_em] >=0) 
  ...
  if(en_beam[fbeam_en]>1. && en_beam[fbeam_en]<2. && (sc[ind_em] < 0.5 ||  cc[ind_em] < 0.5 || q[ind_em] >=0 || ec_ei[ec[ind_em] - 1] < 0.05 || ece/p[ind_em]<fsub_e->Eval(p[ind_em]) || ece/p[ind_em] >fsum_e->Eval(p[ind_em]) || p[ind_em]<min_good_mom || ece/p[ind_em] <0.2 || el_sccc_timediff<sc_cc_delt_cut_sect[el_cc_sector-1] ||   cc_c2[cc[ind_em]-1]>0.1)) 
   {continue;}
  ...
  if(en_beam[fbeam_en]<3.&& en_beam[fbeam_en]>2    &&(ec[ind_em] < 0.5 || cc[ind_em] < 0.5 ||  sc[ind_em] < 0.5 || q[ind_em] >=0 || ec_ei[ec[ind_em] - 1] < 0.06 || ece/p[ind_em]<fsub_e->Eval(p[ind_em]) || ece/p[ind_em] >fsum_e->Eval(p[ind_em]) || p[ind_em]<min_good_mom || cc_c2[cc[ind_em]-1]>=0.1 || el_sccc_timediff<sc_cc_delt_cut_sect[el_cc_sector-1]  || TMath::Sqrt(p[ind_em]*p[ind_em]+e_mass*e_mass)>en_beam[fbeam_en])) //electron pid cuts
    ...
    h1_el_ec_sc_timediff_sect[el_cc_sector-1]->Fill(ec_t[ec[ind_em]-1]-sc_t[sc[ind_em]-1]-(ec_r[ec[ind_em]-1]-sc_r[sc[ind_em]-1])/(c*ns_to_s)); 
    h1_el_ec_sc_timediff_sect_corr[el_cc_sector-1]->Fill(ec_t[ec[ind_em]-1]-sc_t[sc[ind_em]-1]-(ec_r[ec[ind_em]-1]-sc_r[sc[ind_em]-1])/(c*ns_to_s)-EC_time_offset[make_pair(ftarget,el_ec_sector)]);   
    h2_el_E_p_ratio_cut->Fill(p[ind_em], ece/p[ind_em]);
    if(sc_paddle==5) {
      h1_el_ec_sc_timediff->Fill(ec_t[ec[ind_em]-1]-sc_t[sc[ind_em]-1]-(ec_r[ec[ind_em]-1]-sc_r[sc[ind_em]-1])/(c*ns_to_s));
      h1_el_ec_sc_timediff_corr->Fill(ec_t[ec[ind_em]-1]-sc_t[sc[ind_em]-1]-(ec_r[ec[ind_em]-1]-sc_r[sc[ind_em]-1])/(c*ns_to_s)-EC_time_offset[make_pair(ftarget,el_ec_sector)]);
    }
    h1_el_ec_sc_timediff_allSCpd->Fill(ec_t[ec[ind_em]-1]-sc_t[sc[ind_em]-1]-(ec_r[ec[ind_em]-1]-sc_r[sc[ind_em]-1])/(c*ns_to_s));
    h1_el_ec_sc_timediff_corr_allSCpd->Fill(ec_t[ec[ind_em]-1]-sc_t[sc[ind_em]-1]-(ec_r[ec[ind_em]-1]-sc_r[sc[ind_em]-1])/(c*ns_to_s)-EC_time_offset[make_pair(ftarget,el_ec_sector)]);
    ...
    double E_rec=(2*(m_prot-eps)*V4_el.E()+m_prot*m_prot-(m_prot-eps)*(m_prot-eps))/(2*(m_prot-eps-V4_el.E()+V4_el.Rho()*cz[ind_em]));   //neutrino analysis
    double E_rec_new= (m_prot*eps+m_prot*V4_el.E())/(m_prot-V4_el.E()+V4_el.Rho()*cz[ind_em]);   //neutrino analysis
    E_rec=E_rec_new;
    ...
    int num_p = 0,num_pi=0,num_pimi=0,num_pipl=0,num_chargedpi=0;
    int index_n[20],ec_index_n[20],ec_index_neutrons[20],index_pipl[20],index_pimi[20];
    int num_n = 0,ec_num_n = 0,ec_neutrons=0;
    ...
    double nectime,necpath,necin,necout,nectot,nbetta_corr,ecpath_corr,n_mom_corr,n_mom;
	...
	if( sc[i] > 0 && stat[i] > 0 &&  id[i] == 2212 )
	  {
	    ...
	    TLorentzVector V4_uncorrprot(p[ind_p]*cx[ind_p],p[ind_p]*cy[ind_p],p[ind_p]*cz[ind_p],TMath::Sqrt(m_prot*m_prot+p[ind_p]*p[ind_p]));
	...
	if(q[i]<0 &&  sc[i] > 0 && dc[i]>0 && stat[i] > 0 )
	  {
	    ...
	    if(deltt<fsum_pimi->Eval(p[i]) && deltt>fsub_pimi->Eval(p[i])){
	      ...
	      if(abs(p[i]-1.4)<0.07 && sc_sect[sc[i]-1]==1 && abs(en_beam[fbeam_en]-4.)<1)   h2_pimi_theta_phi_p->Fill(pimi_phi_mod,pimi_theta);
	      if(abs(p[i]-1.)<0.07 && sc_sect[sc[i]-1]==5 && abs(en_beam[fbeam_en]-2.)<1)   h2_pimi_theta_phi_p->Fill(pimi_phi_mod,pimi_theta);
		...
		if(abs(p[i]-1.4)<0.07 && sc_sect[sc[i]-1]==1 && abs(en_beam[fbeam_en]-4.)<1)	h2_pimi_theta_phi_p_fidcut->Fill(pimi_phi_mod,pimi_theta);
		if(abs(p[i]-1.)<0.07 && sc_sect[sc[i]-1]==5 && abs(en_beam[fbeam_en]-2.)<1)	h2_pimi_theta_phi_p_fidcut->Fill(pimi_phi_mod,pimi_theta);
		h2_pimi_theta_phi->Fill(pimi_phi_mod,pimi_theta);

		if(abs(el_vert_corr-pimi_vert_corr)<pimi_vertcut){
		 
		  num_pimi = num_pimi+1;
		  num_chargedpi=num_chargedpi+1;
		  index_pimi[num_pimi - 1]=i;
		  index_pi[num_chargedpi - 1]=i;
	...
	if(q[i]>0 &&  sc[i] > 0 && dc[i]>0 && stat[i] > 0)
	  {
	    ...
	    if(abs(p[i]-1)<0.05 && sc_sect[sc[i]-1]==1 && abs(en_beam[fbeam_en]-4)<1)  h2_pipl_theta_phi_p->Fill(pipl_phi_mod,pipl_theta);
	    if(abs(p[i]-1)<0.05 && sc_sect[sc[i]-1]==5 && abs(en_beam[fbeam_en]-2)<1)   h2_pipl_theta_phi_p->Fill(pipl_phi_mod,pipl_theta);
		...
		h1_pipl_prot_vertdiff->Fill(el_vert_corr-pipl_vert_corr);
	       	if(abs(p[i]-1)<0.05 && sc_sect[sc[i]-1]==1 && abs(en_beam[fbeam_en]-4)<1)	h2_pipl_theta_phi_p_fidcut->Fill(pipl_phi_mod,pipl_theta);
		if(abs(p[i]-1)<0.05 && sc_sect[sc[i]-1]==5 && abs(en_beam[fbeam_en]-2)<1)	h2_pipl_theta_phi_p_fidcut->Fill(pipl_phi_mod,pipl_theta);
	...
	if( lec[i] > 0 && dc[i]<=0  && sc[i]<=0  && stat[i] > 0 &&  q[i] == 0)
	  {
	    if(b[i] > LEC_photon_beta[ftarget]){
	      num_n = num_n + 1;
	      index_n[num_n - 1]=i;
   ...
   if(num_p==1){
	...
	//	if(ec_num_n==0 && num_n==0) skim_tree->Fill();  
 ...
 prot_rot_func_2p(V3_q, V3_2prot_corr,V3_2prot_uncorr, V4_el,E_tot_2p,p_perp_tot_2p,P_N_2p ,&N_prot_both);
     ...
     if(ec_num_n==0 && num_n==0 && num_pi==0 && N_prot_both!=0){
       ...
       Etot_p_bkgd_fracfeed->Fill((E_tot_2p[f]-en_beam[fbeam_en])/en_beam[fbeam_en],P_N_2p[f]*1/Mott_cross_sec);
       Erec_p_bkgd_fracfeed->Fill((E_rec_new-en_beam[fbeam_en])/en_beam[fbeam_en],P_N_2p[f]*1/Mott_cross_sec);
 ...
 if (num_pi==1 && ec_num_n==0 && num_n==0) {
   ...
   V3_1pi.SetXYZ(p[index_pi[0]]*cx[index_pi[0]],p[index_pi[0]]*cy[index_pi[0]],p[index_pi[0]]*cz[index_pi[0]]);
     ...
     V3_2p_rotated[1].Rotate(rot_angle,V3_q);
       ...
       if(q[index_pi[num_pi-1]]>0) pi1_stat=PiplFiducialCut(V3_1pirot, &cphil, &cphir);
       else  pi1_stat=PimiFiducialCut(V3_1pirot, &pimi_phimin, &pimi_phimax);
 ...
 //---------------------------------- 2p 1pi ->2p 0pi   ----------------------------------------------
  ...
  prot_rot_func_2p(V3_q, V3_2prot_corr,V3_2prot_uncorr, V4_el,Ecal_2p1pi_to2p0pi,p_miss_perp_2p1pi_to2p0pi,P_2p1pi_to2p0pi ,&N_2p_det);

 for(int z=0;z<N_2prot;z++){ 

   if(N_all!=0 && N_2p_det!=0){

     Etot_2p1pi_2p0pi->Fill(Ecal_2p1pi_to2p0pi[z],(N_2p_0pi/N_all)*P_2p1pi_to2p0pi[z]*1/Mott_cross_sec);
     Erec_2p1pi_2p0pi->Fill(E_rec_new,(N_2p_0pi/N_all)*P_2p1pi_to2p0pi[z]*1/Mott_cross_sec);
  h2_Erec_pperp_2p1pi_2p0pi->Fill(p_miss_perp_2p1pi_to2p0pi[z],E_rec_new,(N_2p_0pi/N_all)*P_2p1pi_to2p0pi[z]*1/Mott_cross_sec);
     Etot_bkgd09_2p1pi_2p0pi->Fill(Ecal_2p1pi_to2p0pi[z],(N_2p_0pi/N_all)*P_2p1pi_to2p0pi[z]*1/Mott_cross_sec);
     Etot_2p1pi_2p0pi_fracfeed->Fill((Ecal_2p1pi_to2p0pi[z]-en_beam[fbeam_en])/en_beam[fbeam_en],(N_2p_0pi/N_all)*P_2p1pi_to2p0pi[z]*1/Mott_cross_sec);
     Erec_2p1pi_2p0pi_fracfeed->Fill((E_rec_new-en_beam[fbeam_en])/en_beam[fbeam_en],(N_2p_0pi/N_all)*P_2p1pi_to2p0pi[z]*1/Mott_cross_sec);
  h2_pperp_W->Fill(W_var,p_miss_perp_2p1pi_to2p0pi[z],(N_2p_0pi/N_all)*P_2p1pi_to2p0pi[z]*1/Mott_cross_sec);
     for(int i=0;i<n_slice;i++){
       if (p_miss_perp_2p1pi_to2p0pi[z]<pperp_max[i] && p_miss_perp_2p1pi_to2p0pi[z]>pperp_min[i]){
	 h1_Etot_p_bkgd_slice_2p1pi_to2p0pi[i]->Fill(Ecal_2p1pi_to2p0pi[z],(N_2p_0pi/N_all)*P_2p1pi_to2p0pi[z]*1/Mott_cross_sec);
	 h1_Erec_p_bkgd_slice_2p1pi_to2p0pi[i]->Fill(E_rec_new,(N_2p_0pi/N_all)*P_2p1pi_to2p0pi[z]*1/Mott_cross_sec);
       }
     }
     for (int i=0;i<N_pperp;i++){
       for(int j=0;j<N_Ecal;j++){
	 if(Ecal_2p1pi_to2p0pi[z]>Ecal_lowlim[j] && Ecal_2p1pi_to2p0pi[z]<Ecal_uplim[j] && p_miss_perp_2p1pi_to2p0pi[z]>pperp_cut[i])   h1_Etot_p_bkgd_slice_Ecalcut_2p1pito2p0pi[i][j]->Fill(Ecal_2p1pi_to2p0pi[z],(N_2p_0pi/N_all)*P_2p1pi_to2p0pi[z]*1/Mott_cross_sec);
       }
     }
 ...
 prot1_pi1_rot_func(V3_q,V3_2prot_uncorr[z],V3_1pi, q[index_pi[num_pi-1]], &N_pidet,&N_piundet);

 if(N_all!=0 &&  N_pidet!=0){

   Etot_2p1pi_1p1pi->Fill(E_tot_2p[z],(N_1p_1pi[z]/N_all)*(N_piundet/N_pidet)*1/Mott_cross_sec);
   Erec_2p1pi_1p1pi->Fill(E_rec_new,(N_1p_1pi[z]/N_all)*(N_piundet/N_pidet)*1/Mott_cross_sec);
 h2_Erec_pperp_2p1pi_1p1pi->Fill(p_perp_tot_2p[z],E_rec_new,(N_1p_1pi[z]/N_all)*(N_piundet/N_pidet)*1/Mott_cross_sec);
   Etot_bkgd09_2p1pi_1p1pi->Fill(E_tot_2p[z],(N_1p_1pi[z]/N_all)*(N_piundet/N_pidet)*1/Mott_cross_sec);
   Etot_2p1pi_1p1pi_fracfeed->Fill((E_tot_2p[z]-en_beam[fbeam_en])/en_beam[fbeam_en],(N_1p_1pi[z]/N_all)*(N_piundet/N_pidet)*1/Mott_cross_sec);
   Erec_2p1pi_1p1pi_fracfeed->Fill((E_rec_new-en_beam[fbeam_en])/en_beam[fbeam_en],(N_1p_1pi[z]/N_all)*(N_piundet/N_pidet)*1/Mott_cross_sec);
  h2_pperp_W->Fill(W_var,p_perp_tot_2p[z],(N_1p_1pi[z]/N_all)*(N_piundet/N_pidet)*1/Mott_cross_sec);
   for(int i=0;i<n_slice;i++){
     if (p_perp_tot_2p[z]<pperp_max[i] && p_perp_tot_2p[z]>pperp_min[i]){
       h1_Etot_p_bkgd_slice_2p1pi_to1p1pi[i]->Fill(E_tot_2p[z],(N_1p_1pi[z]/N_all)*(N_piundet/N_pidet)*1/Mott_cross_sec);
       h1_Erec_p_bkgd_slice_2p1pi_to1p1pi[i]->Fill(E_rec_new,(N_1p_1pi[z]/N_all)*(N_piundet/N_pidet)*1/Mott_cross_sec);
     }
   }
   for (int i=0;i<N_pperp;i++){
     for(int j=0;j<N_Ecal;j++){
       if(E_tot_2p[z]>Ecal_lowlim[j] && E_tot_2p[z]<Ecal_uplim[j] && p_perp_tot_2p[z]>pperp_cut[i])   h1_Etot_p_bkgd_slice_Ecalcut_2p1pito1p1pi[i][j]->Fill(E_tot_2p[z],(N_1p_1pi[z]/N_all)*(N_piundet/N_pidet)*1/Mott_cross_sec);
     }
   }
...
//---------------------------------- 2p 1pi ->1p 0pi   ----------------------------------------------
 if(N_all!=0){
   ...
   Etot_2p1pi_1p0pi->Fill(E_tot_2p[z],(N_1p_0pi[z]/N_all)*1/Mott_cross_sec);
   Erec_2p1pi_1p0pi->Fill(E_rec_new,(N_1p_0pi[z]/N_all)*1/Mott_cross_sec);
   h2_Erec_pperp_2p1pi_1p0pi->Fill(p_perp_tot_2p[z],E_rec_new,(N_1p_0pi[z]/N_all)*1/Mott_cross_sec);
   Etot_bkgd09_2p1pi_1p0pi->Fill(E_tot_2p[z],(N_1p_0pi[z]/N_all)*1/Mott_cross_sec);
   Etot_2p1pi_1p0pi_fracfeed->Fill((E_tot_2p[z]-en_beam[fbeam_en])/en_beam[fbeam_en],(N_1p_0pi[z]/N_all)*1/Mott_cross_sec);
   Erec_2p1pi_1p0pi_fracfeed->Fill((E_rec_new-en_beam[fbeam_en])/en_beam[fbeam_en],(N_1p_0pi[z]/N_all)*1/Mott_cross_sec);
   h2_pperp_W->Fill(W_var,p_perp_tot_2p[z],-(N_1p_0pi[z]/N_all)*1/Mott_cross_sec);
   for(int i=0;i<n_slice;i++)
     {
       if (p_perp_tot_2p[z]<pperp_max[i] && p_perp_tot_2p[z]>pperp_min[i]){
	 h1_Etot_p_bkgd_slice_2p1pi_to1p0pi[i]->Fill(E_tot_2p[z],(N_1p_0pi[z]/N_all)*1/Mott_cross_sec);
	 h1_Erec_p_bkgd_slice_2p1pi_to1p0pi[i]->Fill(E_rec_new,(N_1p_0pi[z]/N_all)*1/Mott_cross_sec);
       }
     }
   for (int i=0;i<N_pperp;i++){
     for(int j=0;j<N_Ecal;j++){
       if(E_tot_2p[z]>Ecal_lowlim[j] && E_tot_2p[z]<Ecal_uplim[j] && p_perp_tot_2p[z]>pperp_cut[i])   h1_Etot_p_bkgd_slice_Ecalcut_2p1pito1p0pi[i][j]->Fill(E_tot_2p[z],(N_1p_0pi[z]/N_all)*1/Mott_cross_sec);
     }
   }
	 ...
	 if(num_p==3){ 
	   ...
	   if((el_vert_corr- prot_vz_corr[0])>vertdiff_min[ftarget] && (el_vert_corr- prot_vz_corr[0])<vertdiff_max[ftarget] && 
	     ...
	     if(ec_num_n==0 && num_n==0 && num_pi==0 && N_p_three!=0){
 //-----------------------------------------  3p to 2p->1p  -----------------------------------------------------------------------
		 ...
		 for(int j=0;j<N_2p;j++)    { 
		   ...
		   Etot_3pto2p_fracfeed->Fill((E_cal_3pto2p[count][j]-en_beam[fbeam_en])/en_beam[fbeam_en], P_3pto2p[count][j]*1/Mott_cross_sec);
		   Erec_3pto2p_fracfeed->Fill((E_rec_new-en_beam[fbeam_en])/en_beam[fbeam_en], P_3pto2p[count][j]*1/Mott_cross_sec);
 ...
 //-----------------------------------------  3p to 1p  -----------------------------------------------------------------------
		 ...
		 Etot_3pto1p_fracfeed->Fill((E_cal[j]-en_beam[fbeam_en])/en_beam[fbeam_en], P_3pto1p[j]*1/Mott_cross_sec);
		 Erec_3pto1p_fracfeed->Fill((E_rec_new-en_beam[fbeam_en])/en_beam[fbeam_en],P_3pto1p[j]*1/Mott_cross_sec);
	   ...
	   if((el_vert_corr- prot4_vz_corr[0])>vertdiff_min[ftarget] && (el_vert_corr- prot4_vz_corr[0])<vertdiff_max[ftarget] &&
	     ...
	     if(ec_num_n==0 && num_n==0 && num_pi==0){
		 ...
		 if(!prot4_stat[0]  &&  prot4_stat[1]  &&  prot4_stat[2]  &&  prot4_stat[3])  N_p4_p3[3]=N_p4_p3[3]+1;
	       ...
	       TVector3 V3_prot[N_3p],V3_prot_uncorr[N_3p],V3_prot_el_4pto3p[N_3p][N_2p];
	   ...
	   //-----------------------------------------  4p to 3p->2->1  -----------------------------------------------------------------------
		     ...
		     for(int j=0;j<N_2p;j++)    {  //looping through number of 1 proton combination out of 2 protons
		       ...
		       Etot_4pto3p_fracfeed->Fill((E_cal_4pto3p[count][j]-en_beam[fbeam_en])/en_beam[fbeam_en], P_4pto3p[count][j]*(N_p4_p3[g]/N_p_four)*1/Mott_cross_sec);
		       Erec_4pto3p_fracfeed->Fill((E_rec_new-en_beam[fbeam_en])/en_beam[fbeam_en], P_4pto3p[count][j]*(N_p4_p3[g]/N_p_four)*1/Mott_cross_sec); 
		   ...
		   //-----------------------------------------  4p to 3p->1  -----------------------------------------------------------------------
		     ...
		     Etot_43pto1p_fracfeed->Fill((E_cal_43pto1p[j]-en_beam[fbeam_en])/en_beam[fbeam_en], P_43pto1p[j]*1/Mott_cross_sec);
		     Erec_43pto1p_fracfeed->Fill((E_rec_new-en_beam[fbeam_en])/en_beam[fbeam_en],P_43pto1p[j]*1/Mott_cross_sec); 
  ...
  //-----------------------------------------  4p to 2p->1  -----------------------------------------------------------------------
		 ...
		 for(int ind2=0;ind2<N_p4;ind2++){
		   if(ind1!=ind2 && ind1<ind2){
			 ...
			 Etot_4pto2p_fracfeed->Fill((E_cal_4pto2p[j]-en_beam[fbeam_en])/en_beam[fbeam_en], P_4pto2p[j]*(N_p4_p2[N_4to2]/N_p_four)*1/Mott_cross_sec);
			 Erec_4pto2p_fracfeed->Fill((E_rec_new-en_beam[fbeam_en])/en_beam[fbeam_en], P_4pto2p[j]*(N_p4_p2[N_4to2]/N_p_four)*1/Mott_cross_sec); 
			 h2_pperp_W->Fill(W_var,p_miss_perp_4pto2p[j], P_4pto2p[j]*1/Mott_cross_sec);
 ...
 //-----------------------------------------  4p to 1p  -----------------------------------------------------------------------
		 ...
		 for(int j=0;j<N_p4;j++)    {       //estimating the undetected 4p contribution to  1p
		   ...
		   Etot_4pto1p_fracfeed->Fill((E_cal_p4[j]-en_beam[fbeam_en])/en_beam[fbeam_en], P_4pto1p[j]*1/Mott_cross_sec);
		   Erec_4pto1p_fracfeed->Fill((E_rec_new-en_beam[fbeam_en])/en_beam[fbeam_en],P_4pto1p[j]*1/Mott_cross_sec); 
 ...
 double N_pipl, N_pimi, N_nopipl,N_nopimi,P_undet=0;
	...
	h1_E_rec->Fill(E_rec_new,1/Mott_cross_sec);
	 ...
	 if(ec_num_n==0 && num_n==0 && num_pi==0){
	   ...
	   h1_E_rec_0pi_frac_feed->Fill((E_rec_new-en_beam[fbeam_E])/en_beam[fbeam_E],1/Mott_cross_sec);
  
	 }
//----------------------------- e- ,1pi  ----------------------------------------- 

	 if (ec_num_n==0 && num_n==0 && num_pi==1) {

	   V3_pi.SetXYZ(p[index_pi[0]]*cx[index_pi[0]],p[index_pi[0]]*cy[index_pi[0]],p[index_pi[0]]*cz[index_pi[0]]);	
	   pi1_rot_func(V3_pi,q[index_pi[0]], V3_q, &P_undet);
		   
	   h1_E_rec_1pi_weight->Fill(E_rec_new,P_undet*1/Mott_cross_sec);
	   h1_E_rec_1pi_weight_frac_feed->Fill((E_rec_new-en_beam[fbeam_E])/en_beam[fbeam_E],P_undet*1/Mott_cross_sec);
     
	   h1_E_rec_1pi->Fill(E_rec_new,1/Mott_cross_sec);			           
	 }
//----------------------------- e- ,2pi  ----------------------------------------- 
...
if (ec_num_n==0 && num_n==0 && num_pi==2) {
 
  V3_2pi[0].SetXYZ(p[index_pi[0]]*cx[index_pi[0]],p[index_pi[0]]*cy[index_pi[0]],p[index_pi[0]]*cz[index_pi[0]]);
  V3_2pi[1].SetXYZ(p[index_pi[1]]*cx[index_pi[1]],p[index_pi[1]]*cy[index_pi[1]],p[index_pi[1]]*cz[index_pi[1]]);
  pi2_q[0]=q[index_pi[0]];
  pi2_q[1]=q[index_pi[1]];

 pi2_rot_func(V3_2pi, pi2_q, V3_q,&P_0pi,P_1pi);
 //----------------------------- e- ,2pi->0pi (-) -----------------------------------------
 h1_E_rec_2pi_weight->Fill(E_rec_new,(-P_0pi)*1/Mott_cross_sec);
 h1_E_rec_2pi_weight_frac_feed->Fill((E_rec_new-en_beam[fbeam_E])/en_beam[fbeam_E],(-P_0pi)*1/Mott_cross_sec);
...
//----------------------------- e- ,2pi->1pi->0pi (+)  -----------------------------------------
 ...
 h1_E_rec_2pi_weight_frac_feed->Fill((E_rec_new-en_beam[fbeam_E])/en_beam[fbeam_E],P_1pi[k]*1/Mott_cross_sec);
...
TVector3 V3_3pi[N_3pi];
 int q_pi3[N_3pi]={0};
 double P_0pion=0,P_1pion[N_3pi],P_320pi[N_3pi],P_3210pi[N_3pi][N_2pi];

if (ec_num_n==0 && num_n==0 && num_pi==3) {
  for (int h=0;h<N_3pi;h++){

    V3_3pi[h].SetXYZ(p[index_pi[h]]*cx[index_pi[h]],p[index_pi[h]]*cy[index_pi[h]],p[index_pi[h]]*cz[index_pi[h]]);
    q_pi3[h]=q[index_pi[h]];
  }
  pi3_rot_func(V3_3pi, q_pi3,V3_q,&P_0pion, P_1pion, P_320pi,P_3210pi);

  
 //---------------------------3pi->0pi----------------------------------------------
    h1_E_rec_3pi_weight->Fill(E_rec_new,(-P_0pion)*1/Mott_cross_sec);
    h1_E_rec_3pi_weight_frac_feed->Fill((E_rec_new-en_beam[fbeam_E])/en_beam[fbeam_E],(-P_0pion)*1/Mott_cross_sec);
h1_E_rec_30pi->Fill(E_rec_new,(P_0pion)*1/Mott_cross_sec);
 ...
 //---------------------------3pi->1pi->0pi----------------------------------------------
  ...
  h1_E_rec_3pi_weight->Fill(E_rec_new,P_1pion[h]*1/Mott_cross_sec);
    h1_E_rec_3pi_weight_frac_feed->Fill((E_rec_new-en_beam[fbeam_E])/en_beam[fbeam_E],P_1pion[h]*1/Mott_cross_sec);
h1_E_rec_310pi->Fill(E_rec_new,(P_1pion[h])*1/Mott_cross_sec);
 
 //---------------------------3pi->2pi->0pi----------------------------------------------   
    h1_E_rec_3pi_weight->Fill(E_rec_new,P_320pi[h]*1/Mott_cross_sec);
    h1_E_rec_3pi_weight_frac_feed->Fill((E_rec_new-en_beam[fbeam_E])/en_beam[fbeam_E],P_320pi[h]*1/Mott_cross_sec);
...
//---------------------------3pi->2pi->1pi->0pi----------------------------------------------
    ...
    h1_E_rec_3pi_weight_frac_feed->Fill((E_rec_new-en_beam[fbeam_E])/en_beam[fbeam_E],(-P_3210pi[h][g])*1/Mott_cross_sec);
 ...
 double N_2pi_p=0,N_1pi_1p[N_2pi]={0},N_pi=0,N_nopi=0,N_0pi_1p=0;
V3_q=(V4_beam-V4_el).Vect();
 ...
 if (num_pi==2 && ec_num_n==0 && num_n==0 ) {
   ...
   V3_2pi[0].SetXYZ(p[index_pi[0]]*cx[index_pi[0]],p[index_pi[0]]*cy[index_pi[0]],p[index_pi[0]]*cz[index_pi[0]]);
   V3_2pi[1].SetXYZ(p[index_pi[1]]*cx[index_pi[1]],p[index_pi[1]]*cy[index_pi[1]],p[index_pi[1]]*cz[index_pi[1]]);
   N_2pi_p=N_1pi_1p[0]=N_1pi_1p[1]=N_pi=N_nopi=0;	
   
   for(int g=0; g<N_tot; g++){

     rot_angle=gRandom->Uniform(0,2*TMath::Pi());

     V3_2pi_rot[0]=V3_2pi[0];
     V3_2pi_rot[1]=V3_2pi[1];
     V3_p_rot=V3_prot_uncorr;
     V3_2pi_rot[0].Rotate(rot_angle,V3_q);
     V3_2pi_rot[1].Rotate(rot_angle,V3_q);
     V3_p_rot.Rotate(rot_angle,V3_q);      

     for(int z=0;z<N_2pi;z++){
       if(q[index_pi[z]]>0) pi2_stat[z]=PiplFiducialCut(V3_2pi_rot[z], &cphil, &cphir);
       else  pi2_stat[z]=PimiFiducialCut(V3_2pi_rot[z], &pimi_phimin, &pimi_phimax);
     }

     if(PFiducialCut(V3_p_rot) &&  pi2_stat[0] && !pi2_stat[1])  N_1pi_1p[0]=N_1pi_1p[0]+1; 
     if(PFiducialCut(V3_p_rot) && !pi2_stat[0] &&  pi2_stat[1])  N_1pi_1p[1]=N_1pi_1p[1]+1; 
     if(PFiducialCut(V3_p_rot) && !pi2_stat[0] && !pi2_stat[1])  N_0pi_1p=N_0pi_1p+1; 
     if(PFiducialCut(V3_p_rot) &&  pi2_stat[0] &&  pi2_stat[1])  N_2pi_p=N_2pi_p+1;
 ...
 //---------------------------------- 1p 2pi->1p1pi   ----------------------------------------------
   ...
   for(int z=0;z<N_2pi;z++){  //to consider 2 diff. 1pi states
     ...
     prot1_pi1_rot_func(V3_q,V3_prot_uncorr,V3_2pi[z], q[index_pi[z]], &N_pi,&N_nopi);
     if(N_2pi_p!=0 && N_pi!=0){

       Etot_1p2pi->Fill(E_tot,(N_nopi/N_pi)*(N_1pi_1p[z]/N_2pi_p)*1/Mott_cross_sec);
       Erec_1p2pi->Fill(E_rec_new,(N_nopi/N_pi)*(N_1pi_1p[z]/N_2pi_p)*1/Mott_cross_sec);
       h2_Erec_pperp_1p2pi_1p1pi->Fill(p_perp_tot,E_rec_new,(N_nopi/N_pi)*(N_1pi_1p[z]/N_2pi_p)*1/Mott_cross_sec);
       Etot_bkgd09_1p2pi_1p1pi->Fill(E_tot,(N_nopi/N_pi)*(N_1pi_1p[z]/N_2pi_p)*1/Mott_cross_sec);
       Etot_1p2pi_fracfeed->Fill((E_tot-en_beam[fbeam_E])/en_beam[fbeam_E],(N_nopi/N_pi)*(N_1pi_1p[z]/N_2pi_p)*1/Mott_cross_sec);
       Erec_1p2pi_fracfeed->Fill((E_rec_new-en_beam[fbeam_E])/en_beam[fbeam_E],(N_nopi/N_pi)*(N_1pi_1p[z]/N_2pi_p)*1/Mott_cross_sec);
       h2_pperp_W->Fill(W_var,p_perp_tot,(N_nopi/N_pi)*(N_1pi_1p[z]/N_2pi_p)*1/Mott_cross_sec);

       for(int i=0;i<n_slice;i++){
	 if (p_perp_tot<pperp_max[i] && p_perp_tot>pperp_min[i]){
	   h1_Etot_bkgd_1p2pi[i]->Fill(E_tot,(N_nopi/N_pi)*(N_1pi_1p[z]/N_2pi_p)*1/Mott_cross_sec);
	   h1_Erec_bkgd_1p2pi[i]->Fill(E_rec_new,(N_nopi/N_pi)*(N_1pi_1p[z]/N_2pi_p)*1/Mott_cross_sec);
	 }
       }
       for (int i=0;i<N_pperp;i++){
	 for(int j=0;j<N_Ecal;j++){
	   if(E_tot>Ecal_lowlim[j] && E_tot<Ecal_uplim[j] && p_perp_tot>pperp_cut[i])   h1_Etot_p_bkgd_slice_Ecalcut_1p2pito1p1pi[i][j]->Fill(E_tot,(N_nopi/N_pi)*(N_1pi_1p[z]/N_2pi_p)*1/Mott_cross_sec);
	 }
       }          
 ...
 //---------------------------------- 1p 2pi->1p0pi   ----------------------------------------------
  if(N_2pi_p!=0){
    ...
    Etot_1p2pi_1p0pi->Fill(E_tot,(N_0pi_1p/N_2pi_p)*1/Mott_cross_sec);
      Erec_1p2pi_1p0pi->Fill(E_rec_new,(N_0pi_1p/N_2pi_p)*1/Mott_cross_sec);
      h2_Erec_pperp_1p2pi_1p0pi->Fill(p_perp_tot,E_rec_new,(N_0pi_1p/N_2pi_p)*1/Mott_cross_sec);
      Etot_bkgd09_1p2pi_1p0pi->Fill(E_tot,(N_0pi_1p/N_2pi_p)*1/Mott_cross_sec);
      Etot_1p2pi_1p0pi_fracfeed->Fill((E_tot-en_beam[fbeam_E])/en_beam[fbeam_E],(N_0pi_1p/N_2pi_p)*1/Mott_cross_sec);
      Erec_1p2pi_1p0pi_fracfeed->Fill((E_rec_new-en_beam[fbeam_E])/en_beam[fbeam_E],(N_0pi_1p/N_2pi_p)*1/Mott_cross_sec);
      h2_pperp_W->Fill(W_var,p_perp_tot,-(N_0pi_1p/N_2pi_p)*1/Mott_cross_sec);
      for(int i=0;i<n_slice;i++){
      if (p_perp_tot<pperp_max[i] && p_perp_tot>pperp_min[i]){
	h1_Etot_bkgd_1p2pi_1p0pi[i]->Fill(E_tot,(N_0pi_1p/N_2pi_p)*1/Mott_cross_sec);
	h1_Erec_bkgd_1p2pi_1p0pi[i]->Fill(E_rec_new,(N_0pi_1p/N_2pi_p)*1/Mott_cross_sec);
      }
    }
    for (int i=0;i<N_pperp;i++){
      for(int j=0;j<N_Ecal;j++){
	if(E_tot>Ecal_lowlim[j] && E_tot<Ecal_uplim[j] && p_perp_tot>pperp_cut[i])   h1_Etot_p_bkgd_slice_Ecalcut_1p2pito1p0pi[i][j]->Fill(E_tot,(N_0pi_1p/N_2pi_p)*1/Mott_cross_sec);
      }
    }       
 ...
 if (num_pipl==1) {
   V3_pipl.SetXYZ(p[index_pipl[0]]*cx[index_pipl[0]],p[index_pipl[0]]*cy[index_pipl[0]],p[index_pipl[0]]*cz[index_pipl[0]]);	N_pipl=N_nopipl=0;
   prot1_pi1_rot_func(V3_q,V3_prot_uncorr,V3_pipl, q[index_pipl[0]], &N_pipl,&N_nopipl);
 }
	  
 if (num_pimi==1) {
   V3_pimi.SetXYZ(p[index_pimi[0]]*cx[index_pimi[0]],p[index_pimi[0]]*cy[index_pimi[0]],p[index_pimi[0]]*cz[index_pimi[0]]);
   N_pimi=N_nopimi=0;
   prot1_pi1_rot_func(V3_q,V3_prot_uncorr,V3_pimi, q[index_pimi[0]], &N_pimi,&N_nopimi);
 }
	 ...
	 for(int i=0;i<n_slice;i++)
	   {
	     if (p_perp_tot<pperp_max[i] && p_perp_tot>pperp_min[i]){
	       ...
	       if (num_pi==0 && ec_num_n==0 && num_n==0)	   {

		 h1_Etot_Npi0[i]->Fill(E_tot,1/Mott_cross_sec);
		 h1_Erec_Npi0_new[i]->Fill(E_rec_new,1/Mott_cross_sec);
	       }	 
	       	
	       if (ec_num_n==0 && num_n==0 && num_pimi==0 && num_pipl==1) {

		 if(N_pipl!=0){
		  
		   h1_E_rec_undetfactor->Fill(E_rec_new,(N_nopipl/N_pipl)*1/Mott_cross_sec);
		   h1_E_tot_undetfactor->Fill(E_tot,(N_nopipl/N_pipl)*1/Mott_cross_sec);
		   h1_E_tot_undetfactor_pipl->Fill(E_tot,(N_nopipl/N_pipl)*1/Mott_cross_sec);
		   h1_Etot_bkgd_pipl_pimi_fact[i]->Fill(E_tot,(N_nopipl/N_pipl)*1/Mott_cross_sec);
		   h1_Erec_bkgd_pipl_pimi_new_fact[i]->Fill(E_rec_new,(N_nopipl/N_pipl)*1/Mott_cross_sec);
		   h1_Etot_bkgd_pipl_pimi_fact_pipl[i]->Fill(E_tot,(N_nopipl/N_pipl)*1/Mott_cross_sec);
		   h1_E_tot_undetfactor09->Fill(E_tot,(N_nopipl/N_pipl)*1/Mott_cross_sec);
		   h2_Erec_pperp_1p1pi->Fill(p_perp_tot,E_rec_new,(N_nopipl/N_pipl)*1/Mott_cross_sec);
		   h1_E_rec_undetfactor_fracfeed->Fill((E_rec_new-en_beam[fbeam_E])/en_beam[fbeam_E],(N_nopipl/N_pipl)*1/Mott_cross_sec);
		   h1_E_tot_undetfactor_fracfeed->Fill((E_tot-en_beam[fbeam_E])/en_beam[fbeam_E],(N_nopipl/N_pipl)*1/Mott_cross_sec);
		   h2_pperp_W->Fill(W_var,p_perp_tot,-(N_nopipl/N_pipl)*1/Mott_cross_sec);
		   for (int i=0;i<N_pperp;i++){
		     for(int j=0;j<N_Ecal;j++){
		       if(E_tot>Ecal_lowlim[j] && E_tot<Ecal_uplim[j] && p_perp_tot>pperp_cut[i])   h1_Etot_bkgd_pipl_pimi_fact_Ecalcut[i][j]->Fill(E_tot,(N_nopipl/N_pipl)*1/Mott_cross_sec);
	       ...
	       if (ec_num_n==0 && num_n==0 && num_pimi==1 && num_pipl==0) {

		 if(N_pimi!=0){		      

		   h1_E_rec_undetfactor->Fill(E_rec_new,(N_nopimi/N_pimi)*1/Mott_cross_sec);
		   h1_E_tot_undetfactor->Fill(E_tot,(N_nopimi/N_pimi)*1/Mott_cross_sec);
		   h1_E_tot_undetfactor_pimi->Fill(E_tot,(N_nopimi/N_pimi)*1/Mott_cross_sec);
		   h1_Etot_bkgd_pipl_pimi_fact[i]->Fill(E_tot,(N_nopimi/N_pimi)*1/Mott_cross_sec);
		   h1_Erec_bkgd_pipl_pimi_new_fact[i]->Fill(E_rec_new,(N_nopimi/N_pimi)*1/Mott_cross_sec);
		   h1_Etot_bkgd_pipl_pimi_fact_pimi[i]->Fill(E_tot,(N_nopimi/N_pimi)*1/Mott_cross_sec);
		   h1_E_tot_undetfactor09->Fill(E_tot,(N_nopimi/N_pimi)*1/Mott_cross_sec);
		   h2_Erec_pperp_1p1pi->Fill(p_perp_tot,E_rec_new,(N_nopimi/N_pimi)*1/Mott_cross_sec);
		   h1_E_rec_undetfactor_fracfeed->Fill((E_rec_new-en_beam[fbeam_E])/en_beam[fbeam_E],(N_nopimi/N_pimi)*1/Mott_cross_sec);
		   h1_E_tot_undetfactor_fracfeed->Fill((E_tot-en_beam[fbeam_E])/en_beam[fbeam_E],(N_nopimi/N_pimi)*1/Mott_cross_sec);
		   h2_pperp_W->Fill(W_var,p_perp_tot,-(N_nopimi/N_pimi)*1/Mott_cross_sec);
		   for (int i=0;i<N_pperp;i++){
		     for(int j=0;j<N_Ecal;j++){
		       if(E_tot>Ecal_lowlim[j] && E_tot<Ecal_uplim[j] && p_perp_tot>pperp_cut[i])   h1_Etot_bkgd_pipl_pimi_fact_Ecalcut[i][j]->Fill(E_tot,(N_nopimi/N_pimi)*1/Mott_cross_sec);
	 ...
	 if (num_pi==0){
	   ...
	   if(ec_num_n==0 && num_n==0) {
	     ...
	     h1_E_tot_cut2_fracfeed->Fill((E_tot-en_beam[fbeam_E])/en_beam[fbeam_E],1/Mott_cross_sec);
	     h1_E_rec_cut2_new_fracfeed->Fill((E_rec_new-en_beam[fbeam_E])/en_beam[fbeam_E],1/Mott_cross_sec);
...
//------------------------------------undetected 2p 1pi ->2p 0pi  ------ --------------------------------------
	...
	h1_Etot_p_bkgd_slice_sub2p1pi_2p[i]=(TH1F*) h1_Etot_p_bkgd_slice_sub1p2pi_0pi[i]->Clone(Form("h1_Etot_p_bkgd_slice_sub2p1pi_2p_%d",i+1));
	h1_Etot_p_bkgd_slice_sub2p1pi_2p[i]->Add(h1_Etot_p_bkgd_slice_2p1pi_to2p0pi[i]);
	h1_Erec_p_bkgd_slice_sub2p1pi_2p[i]=(TH1F*) h1_Erec_p_bkgd_slice_sub1p2pi_0pi[i]->Clone(Form("h1_Erec_p_bkgd_slice_sub2p1pi_2p_%d",i+1));
...
h1_Etot_p_bkgd_slice_sub_Ecalcut_2p1pi_2p0pi[i][j]=(TH1F*)  h1_Etot_p_bkgd_slice_sub_Ecalcut_1p2pi_1p0pi[i][j]->Clone(Form("h1_Etot_p_bkgd_slice_sub_Ecalcut_2p1pi_2p0pi_%d_%d",i+1,j+1));
...
//------------------------------------undetected 2p 1pi ->2p 0pi  ------ --------------------------------------
 ...
 TH1F *h_Erec_subtruct_piplpimi_2p1pi_2p0pi=(TH1F*)  h_Erec_subtruct_piplpimi_1p2pi_1p0pi->Clone("h_Erec_subtruct_piplpimi_2p1pi_2p0pi");
 h_Erec_subtruct_piplpimi_2p1pi_2p0pi->Add(Erec_2p1pi_2p0pi);

  TH1F *h_Etot_subtruct_piplpimi_2p1pi_2p0pi=(TH1F*) h_Etot_subtruct_piplpimi_1p2pi_1p0pi->Clone("h_Etot_subtruct_piplpimi_2p1pi_2p0pi");
  h_Etot_subtruct_piplpimi_2p1pi_2p0pi->Add(Etot_2p1pi_2p0pi);

 TH1F *h_Etot_subtruct_piplpimi09_2p1pi_2p0pi=(TH1F*)  h_Etot_subtruct_piplpimi09_1p2pi_1p0pi->Clone("h_Etot_subtruct_piplpimi09_2p1pi_2p0pi");
 h_Etot_subtruct_piplpimi09_2p1pi_2p0pi->Add(Etot_bkgd09_2p1pi_2p0pi);

TH2F *h2_Erec_pperp_sub_2p1pi_2p0pi=(TH2F*) h2_Erec_pperp_sub_1p2pi_1p0pi->Clone("h2_Erec_pperp_sub_2p1pi_2p0pi");
 h2_Erec_pperp_sub_2p1pi_2p0pi->Add(h2_Erec_pperp_2p1pi_2p0pi);

 TH1F *h_Erec_subtruct_piplpimi_2p1pi_2p0pi_fracfeed=(TH1F*)  h_Erec_subtruct_piplpimi_1p2pi_1p0pi_fracfeed->Clone("h_Erec_subtruct_piplpimi_2p1pi_2p0pi_fracfeed");
 h_Erec_subtruct_piplpimi_2p1pi_2p0pi_fracfeed->Add(Erec_2p1pi_2p0pi_fracfeed);

  TH1F *h_Etot_subtruct_piplpimi_2p1pi_2p0pi_fracfeed=(TH1F*) h_Etot_subtruct_piplpimi_1p2pi_1p0pi_fracfeed->Clone("h_Etot_subtruct_piplpimi_2p1pi_2p0pi_fracfeed");
...
for(int i = 0 ; i < 8 ; i++){
  for(int j = 0 ; j < 4 ; j++){
   ...
   // reads FC parameters for 1.1GeV , e- and p fiducial cut parameters at 4GeV
   //
...
Bool_t PFiducialCut(TVector3 momentum){
  ...
  if ( fTorusCurrent>1490 && fTorusCurrent<1510){
    ...
    if(phi<=0) {
      ...
      //    std::cout <<"phi===  "<<phi<< "top " << phicutoff <<"theta=  "<<theta<<" bigger than  "<<phipars[4]<< std::endl;
      status = ((phi<phicutoff) && (theta>phipars[4]));
...
Bool_t PiplFiducialCut(TVector3 momentum, Float_t *philow, Float_t *phiup){
  ...
  if(en_beam[fbeam_E]>1. && en_beam[fbeam_E]<2.){
	...
	phi -= sector*60;
	Float_t p = momentum.Mag();
	if(p < .3) p=.3; //to extrapolate below .3
...
void prot1_pi1_rot_func(TVector3 V3q, TVector3  V3prot,TVector3 V3pi, int q_pi, double *N_pi_p,double *N_nopi_p){
  ...
  double N_tot_rot=100,rotation_ang;
  ...
  Float_t pi_cphil=0,pi_cphir=0,pi_phimin=0,pi_phimax=0;
     ...
     for(int g=0; g<N_tot_rot; g++){
       ...
       if(q_pi>0){
	 if(PFiducialCut(V3_p_rot)  &&  PiplFiducialCut(V3_pi_rot, &pi_cphil, &pi_cphir)) Npi_p=Npi_p+1; 
	 if(PFiducialCut(V3_p_rot)  &&  !PiplFiducialCut(V3_pi_rot, &pi_cphil, &pi_cphir)) Nnopi_p=Nnopi_p+1;}                            
       if(q_pi<0){
	 if(PFiducialCut(V3_p_rot)  && PimiFiducialCut(V3_pi_rot, &pi_phimin, &pi_phimax)) Npi_p=Npi_p+1; 
	 if(PFiducialCut(V3_p_rot)  && !PimiFiducialCut(V3_pi_rot, &pi_phimin, &pi_phimax) ) Nnopi_p=Nnopi_p+1;}
...
void pi1_rot_func(TVector3 V3_pi, int q_pi, TVector3 V3_q,double *P_pi){
 ...
 Float_t pi_cphil=0,pi_cphir=0,pi_phimin=0,pi_phimax=0;
     ...
     for(int g=0; g<N_tot; g++){
       ...
       if(q_pi>0) {if( PiplFiducialCut(V3_rot_pi, &pi_cphil, &pi_cphir)) N_pion=N_pion+1;} 
       if(q_pi<0) {if(PimiFiducialCut(V3_rot_pi, &pi_phimin, &pi_phimax)) N_pion=N_pion+1;} 
...
void pi2_rot_func(TVector3 V3_pi[2], int q_pi[2], TVector3 V3_q,double *P_0pi,double P_1pi[2]){
 ...
 double N_bothpi=0,N_nopi=0,N_1pi[N_pi]={0},P_pi1[N_pi]={0};
	 ...
	 if(q_pi[i]>0) status_pi[i]=PiplFiducialCut(V3_rot_pi[i], &pi_cphil, &pi_cphir); 
	 else status_pi[i]=PimiFiducialCut(V3_rot_pi[i], &pi_phimin, &pi_phimax);
       }
      ...
      pi1_rot_func(V3_pi[0],  q_pi[0],  V3_q,P_pi1);
      pi1_rot_func(V3_pi[1],  q_pi[1],  V3_q,P_pi1+1);
...
void pi3_rot_func(TVector3 V3_pi[3], int q_pi[3], TVector3 V3_q,double *P_0pi,double P_1pi[3],double P_320[3],double P_3210[][2]){
 ...
 //---------------------------3pi->1pi->0pi----------------------------------------------
    for(int h=0;h<N_pi;h++){
      pi1_rot_func(V3_pi[h],q_pi[h],V3_q,&P_pi);
      P_1pi[h]=P_pi*(N_1pi[h]/N_allpi);
    //---------------------------3pi->2pi->0pi----------------------------------------------
   
      if(h==0)   {V3_pion[0]=V3_pi[0];V3_pion[1]=V3_pi[1];}
      if(h==1)   {V3_pion[0]=V3_pi[0];V3_pion[1]=V3_pi[2];}
      if(h==2)   {V3_pion[0]=V3_pi[1];V3_pion[1]=V3_pi[2];}
    pi2_rot_func(V3_pion,q_pion, V3_q,&P_0pion, P_1pion);
