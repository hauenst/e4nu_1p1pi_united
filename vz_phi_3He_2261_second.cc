...
void vz_phi_3He_2261_second()
{
  ...
  TFile *file_in = new TFile("e2a_ep_3He_2261_neutrino6_united4_photsub_test2.root");
  //  TFile *file_in = new TFile("e2a_empty_vert.root");
  // TFile *file_out = new TFile("vz_fits.root", "Recreate");
TFile *file_out = new TFile("vz_3He_2261_2ndrungroup.root", "Recreate");
 ...
 double x_min[6]={0.5, 1.2, 1.6,1.2 , 0.5, 0.2};    //3He
  double x_max[6]={1.5, 2, 2.5, 2.2, 1.5, 1.1};   //3He
