...
void vz_phi_3He_2261_first()
{
  ...
  TFile *file_in = new TFile("e2a_ep_3He_2261_neutrino6_united4_photsub_test.root");
  //  TFile *file_in = new TFile("e2a_empty_vert.root");
  // TFile *file_out = new TFile("vz_fits.root", "Recreate");
TFile *file_out = new TFile("vz_3He_2261.root", "Recreate");
 ...
 double x_min[6]={1.1, 1.2, 1.1,0.7 , 0.6, 0.3};    //3He
  double x_max[6]={1.9, 2, 2., 2, 1.4, 1.4};   //3He
