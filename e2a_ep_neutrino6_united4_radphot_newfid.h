...
// Fri Aug  2 15:04:40 2019 by ROOT version 5.34/36
// from TChain ch/e2a_ep_neutrino6_united4_radphot_newfid
//////////////////////////////////////////////////////////

#ifndef e2a_ep_neutrino6_united4_radphot_newfid_h
#define e2a_ep_neutrino6_united4_radphot_newfid_h
...
class e2a_ep_neutrino6_united4_radphot_newfid {
public :
   ...
   e2a_ep_neutrino6_united4_radphot_newfid(std::string, std::string,TTree *tree=0);
   virtual ~e2a_ep_neutrino6_united4_radphot_newfid();
...
#ifdef e2a_ep_neutrino6_united4_radphot_newfid_cxx
e2a_ep_neutrino6_united4_radphot_newfid::e2a_ep_neutrino6_united4_radphot_newfid(std::string a_target,std::string a_beam_en,TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
     ...
     fbeam_en=a_beam_en;
      ...
      // of trees.
      TChain * chain = new TChain("ch","e2a_ep_neutrino6_united4_radphot_newfid");
...
e2a_ep_neutrino6_united4_radphot_newfid::~e2a_ep_neutrino6_united4_radphot_newfid()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t e2a_ep_neutrino6_united4_radphot_newfid::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t e2a_ep_neutrino6_united4_radphot_newfid::LoadTree(Long64_t entry)
{
...
void e2a_ep_neutrino6_united4_radphot_newfid::Init(TTree *tree)
{
...
Bool_t e2a_ep_neutrino6_united4_radphot_newfid::Notify()
{
...
void e2a_ep_neutrino6_united4_radphot_newfid::Show(Long64_t entry)
{
...
Int_t e2a_ep_neutrino6_united4_radphot_newfid::Cut(Long64_t entry)
{
...
#endif // #ifdef e2a_ep_neutrino6_united4_radphot_newfid_cxx
