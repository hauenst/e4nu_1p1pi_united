...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   energy_reconstruction(std::string, std::string, TTree *tree=0);
...
energy_reconstruction::energy_reconstruction(std::string a_target, std::string a_beam_en, TTree *tree) : fChain(0)
{
   ...
   if (tree == 0) {
     ...
     fbeam_en = a_beam_en;
      ...
      TChain * chain = new TChain("ch","energy_reconstruction");
        ...
        chain->Add(Form("/home/lucas/Documents/01-18-19/%s_%s_skim.root/h10",ftarget.c_str(),fbeam_en.c_str()));
...
void energy_reconstruction::Init(TTree *tree)
{
