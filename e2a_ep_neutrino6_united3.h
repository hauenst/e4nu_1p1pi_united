...
// Fri Jan  4 11:40:12 2019 by ROOT version 5.34/36
// from TChain ch/e2a_ep_neutrino6_united3
//////////////////////////////////////////////////////////

#ifndef e2a_ep_neutrino6_united3_h
#define e2a_ep_neutrino6_united3_h
...
class e2a_ep_neutrino6_united3 {
public :
   ...
   e2a_ep_neutrino6_united3(std::string, std::string, TTree *tree=0);
   virtual ~e2a_ep_neutrino6_united3();
...
#ifdef e2a_ep_neutrino6_united3_cxx
e2a_ep_neutrino6_united3::e2a_ep_neutrino6_united3(std::string a_target, std::string a_beam_en, TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
     ...
     fbeam_en=a_beam_en;
      ...
      // of trees.
      TChain * chain = new TChain("ch","e2a_ep_neutrino6_united3");
        chain->Add(Form("/work/clas/clase2/Mariana/data/e2a_%s_%s_v1/*.root/h10", ftarget.c_str(), fbeam_en.c_str()));
	// chain->Add(Form("/work/clas/clase2/Mariana/data/e2a_%s_%s_v1/*18334*.root/h10", ftarget.c_str(), fbeam_en.c_str()));
      // chain->Add(Form("/work/clas/clase2/Mariana/data/Skim_files/e2a_ep_%s_%s_neutrino6_united2_skim.root/h10", ftarget.c_str(), fbeam_en.c_str()));    //Mariana
      tree = chain;
#endif // SINGLE_TREE
...
e2a_ep_neutrino6_united3::~e2a_ep_neutrino6_united3()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t e2a_ep_neutrino6_united3::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t e2a_ep_neutrino6_united3::LoadTree(Long64_t entry)
{
...
void e2a_ep_neutrino6_united3::Init(TTree *tree)
{
...
Bool_t e2a_ep_neutrino6_united3::Notify()
{
...
void e2a_ep_neutrino6_united3::Show(Long64_t entry)
{
...
Int_t e2a_ep_neutrino6_united3::Cut(Long64_t entry)
{
...
#endif // #ifdef e2a_ep_neutrino6_united3_cxx
