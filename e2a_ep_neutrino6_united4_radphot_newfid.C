#define e2a_ep_neutrino6_united4_radphot_newfid_cxx
#include "e2a_ep_neutrino6_united4_radphot_newfid.h"
...
void e2a_ep_neutrino6_united4_radphot_newfid::Loop()
{
...
cout<<"!!!!!!!! Modified photon PID!!!!!!!!!!!!!"<<endl;
 EC_photon_beta["3He"]=0.88;
 EC_photon_beta["C12"]=0.88;
 EC_photon_beta["CH2"]=0.9;
      */    
      /* 
//2.75sigma
cout<<"!!!!!!!! Modified photon PID!!!!!!!!!!!!!"<<endl;
 EC_photon_beta["3He"]=0.9;
 EC_photon_beta["C12"]=0.9;
 ...
 */
 ...
 elmom_corr_fact[0]=1.001;elmom_corr_fact[1]=0.991;elmom_corr_fact[2]=1.005;elmom_corr_fact[3]=1.004;elmom_corr_fact[4]=1.006;elmom_corr_fact[5]=1.005;//a constant to multiply e- momentum with to correct the location of n peak in MM(3He(e,e'pp)n)
  ...
  TH1F *h1_el_ec_sc_timediff_sect_corr[nsect], *h1_el_ec_sc_timediff_sect[nsect],*h1_beta_ec_corr_sect[nsect],*h1_ec_u_sect[nsect],*h1_ec_v_sect[nsect],*h1_ec_w_sect[nsect],*h1_el_SCpdfidcut[6],*h1_el_SCpd[6],*pos_m_slices[4],*prot_m_slices[4],*pipl_m_slices[4],*h1_pimi_SCpd_sec[6],*h1_pipl_SCpd_sec[6],*h1_prot_SCpd_sec[6];
  TH2F *h2_el_theta_phi_p_beffidcut[6],*h2_el_theta_phi_p_fidcut[6],*h2_el_ec_sc_timediff_ecu[6],*h2_el_ec_sc_timediff_ecv[6],*h2_el_ec_sc_timediff_ecw[6], *h2_el_ec_sc_timediff_SCpd[6],*h2_prot_theta_phi_p_beffidcut[6],*h2_prot_theta_phi_p_fidcut[6],*h2_el_theta_phi_p_beffidcut2[6],*h2_el_theta_phi_p_fidcut2[6],*h2_N_pi_phot[20],*h2_pimi_theta_phi_p_beffidcut[6],*h2_pimi_theta_phi_p_fidcut[6],*h2_pipl_theta_phi_p_beffidcut[6],*h2_pipl_theta_phi_p_fidcut[6],*h2_prot_theta_p[6],*h2_prot_theta_p_cut[6],*h2_pimi_theta_p[6],*h2_pimi_theta_p_cut[6],*h2_pipl_theta_p[6],*h2_pipl_theta_p_cut[6],*h2_pimi_theta_phi_p_sec_beffidcut[6][80],*h2_el_theta_phi_p_sec_beffidcut[6][40],*h2_prot_theta_phi_p_sec_beffidcut[6][80],*h2_prot_theta_phi_p_sec_fidcut[6][80],*h2_pimi_theta_phi_p_sec_fidcut[6][80],*h2_el_theta_phi_p_sec_fidcut[6][40],*h2_pipl_theta_phi_p_sec_beffidcut[6][40],*h2_pipl_theta_phi_p_sec_fidcut[6][40],*h2_prot_theta_SCpd_sec[6],*h2_pimi_phi_theta_p_sec_beffidcut[6][80],*h2_pimi_phi_theta_p_sec_fidcut[6][80];
 ...
 TFile *file_out = new TFile(Form("e2a_ep_%s_%s_neutrino6_united4_radphot_newfid.root",ftarget.c_str(),fbeam_en.c_str()), "Recreate");
  // TFile *file_out = new TFile("e2a_ep_neutrino6_united4_radphot.root", "Recreate");//to submit jobs
  //   TFile *file_out = new TFile(Form("/volatile/clas/clase2/Mariana/Skim_Mariana/e2a_ep_%s_%s_eNpNpi.root",ftarget.c_str(),fbeam_en.c_str()), "Recreate");
...
pars[2]=((TF1 *)file_in7->Get("f_vz"))->GetParameter(2);
  ...
  up_lim1_ec->SetParameters(0.987,30,-0.0002);  
  up_lim2_ec->SetParameters(0.987,90,-0.0002);    
  up_lim3_ec->SetParameters(0.987,150,-0.0002);      
  up_lim4_ec->SetParameters(0.987,210,-0.0002);       
  up_lim5_ec->SetParameters(0.987,270,-0.0002);    
  up_lim6_ec->SetParameters(0.987,330,-0.0002); 
  ...
  leftside_lim1_ec->SetParameters(0.05,7,0.03);
  rightside_lim1_ec->SetParameters(-0.05,-67,0.03);
  leftside_lim2_ec->SetParameters(0.05,-54,0.03);
  rightside_lim2_ec->SetParameters(-0.05,-127,0.03);
  leftside_lim3_ec->SetParameters(0.05,-114,0.03);
  rightside_lim3_ec->SetParameters(-0.05,-187,0.03);
  leftside_lim4_ec->SetParameters(0.05,-174,0.03);
  rightside_lim4_ec->SetParameters(-0.05,-247,0.03);
  leftside_lim5_ec->SetParameters(0.05,-234,0.03);
  rightside_lim5_ec->SetParameters(-0.05,-307,0.03);
  leftside_lim6_ec->SetParameters(0.05,-294,0.03);
  rightside_lim6_ec->SetParameters(-0.05,-367,0.03); 
...
TH1F *h1_Wepp_uncorr = new TH1F("h1_Wepp_uncorr","",400,0,3);
 ...
 TH1F *h1_Q2_weight_sub = new TH1F("h1_Q2_weight_sub","",400,0,6);
...
TH1F *h1_phot_e_angle= new TH1F("h1_phot_e_angle","",300,0,180); 
 TH1F *h1_time_ec=new TH1F("h1_time_ec","",200,-20,20);
  ...
  TH1F *h1_Npi_sub=new TH1F("h1_Npi_sub","",10,0,5);
...
TH1F *h1_beta_ec_corr1 = new TH1F("h1_beta_ec_corr1","",300,0,2);
TH1F *h1_beta_ec_corr_cut = new TH1F("h1_beta_ec_corr_cut","",300,0,2);
TH1F *h1_beta_ec_corr_cut1 = new TH1F("h1_beta_ec_corr_cut1","",300,0,2);
TH1F *h1_el_ec_sc_timediff = new TH1F("h1_el_ec_sc_timediff","",600,-30,30);
 ...
 TH1F *h1_pperp = new TH1F("h1_pperp","",400,0,1);
 TH1F *h1_pperp_QE = new TH1F("h1_pperp_QE","",400,0,1);
...
TH2F *h2_el_E_p_ratio_LAC = new TH2F("h2_el_E_p_ratio_LAC","",200,0,4.5,200,0,0.5);
 ...
 TH2F *h2_neutral_theta_phi_EC_all_fidcut = new TH2F("h2_neutral_theta_phi_EC_all_fidcut","",200,0,360,200,0,180);
  ...
  TH2F *h2_pimi_theta_phi_highp = new TH2F("h2_pimi_theta_phi_highp","",200,0,360,200,0,180);
  TH2F *h2_pimi_theta_phi_lowp = new TH2F("h2_pimi_theta_phi_lowp","",200,0,360,200,0,180);
 ...
 TH2F *h2_Q2_nu = new TH2F("h2_Q2_nu","",200,0,3.5,200,0,5);
  ...
  TH2F *h2_Q2_nu_weight_sub = new TH2F("h2_Q2_nu_weight_sub","",200,0,3.5,200,0,5);
...
TH1F *Etot_2p2pi  = new TH1F("Etot_2p2pi","",n_bins,x_values);
 ...
 TH1F *h1_Etot_QE  = new TH1F("h1_Etot_QE","",n_bins,x_values);
 TH1F *h1_Erec_QE  = new TH1F("h1_Erec_QE","",n_bins,x_values);
 ...
 for(int h=0;h<nsect;h++) {
   ...
   h1_pimi_SCpd_sec[h] = new TH1F(Form("h1_pimi_SCpd_sec_%d",h+1),"",102,-0.5,50.5);
   h1_prot_SCpd_sec[h] = new TH1F(Form("h1_prot_SCpd_sec_%d",h+1),"",102,-0.5,50.5);
   h1_pipl_SCpd_sec[h] = new TH1F(Form("h1_pipl_SCpd_sec_%d",h+1),"",102,-0.5,50.5);
   ...
   h2_prot_theta_SCpd_sec[h] = new TH2F(Form("h2_prot_theta_SCpd_sec_%d",h+1),"",102,-0.5,50.5,200,0,180);
   ...
   h1_ec_u_sect[h] = new TH1F(Form("h1_ec_u_sect_%d",h+1),"",800,0,400);
   h1_ec_v_sect[h] = new TH1F(Form("h1_ec_v_sect_%d",h+1),"",800,0,400);
   h1_ec_w_sect[h] = new TH1F(Form("h1_ec_w_sect_%d",h+1),"",800,0,400);
   ...
   for(int i=0;i<40;i++){
     h2_el_theta_phi_p_sec_beffidcut[h][i]= new TH2F(Form("h2_el_theta_phi_p_sec_beffidcut_%d_%i",h+1,i+1),"",200,h*60,(h+1)*60,540,0,180);
     h2_el_theta_phi_p_sec_fidcut[h][i]= new TH2F(Form("h2_el_theta_phi_p_sec_fidcut_%d_%i",h+1,i+1),"",200,h*60,(h+1)*60,540,0,180);
     h2_pipl_theta_phi_p_sec_beffidcut[h][i]= new TH2F(Form("h2_pipl_theta_phi_p_sec_beffidcut_%d_%i",h+1,i+1),"",200,h*60,(h+1)*60,540,0,180);
     h2_pipl_theta_phi_p_sec_fidcut[h][i]= new TH2F(Form("h2_pipl_theta_phi_p_sec_fidcut_%d_%i",h+1,i+1),"",200,h*60,(h+1)*60,540,0,180);
   }
 for(int i=0;i<80;i++){
 h2_pimi_theta_phi_p_sec_beffidcut[h][i]= new TH2F(Form("h2_pimi_theta_phi_p_sec_beffidcut_%d_%i",h+1,i+1),"",200,h*60,(h+1)*60,200,0,180);
 h2_pimi_theta_phi_p_sec_fidcut[h][i]= new TH2F(Form("h2_pimi_theta_phi_p_sec_fidcut_%d_%i",h+1,i+1),"",200,h*60,(h+1)*60,200,0,180);
 h2_pimi_phi_theta_p_sec_beffidcut[h][i]= new TH2F(Form("h2_pimi_phi_theta_p_sec_beffidcut_%d_%i",h+1,i+1),"",200,0,180,200,-30,30);
 h2_pimi_phi_theta_p_sec_fidcut[h][i]= new TH2F(Form("h2_pimi_phi_theta_p_sec_fidcut_%d_%i",h+1,i+1),"",200,0,180,200,-30,30);
  h2_prot_theta_phi_p_sec_beffidcut[h][i]= new TH2F(Form("h2_prot_theta_phi_p_sec_beffidcut_%d_%i",h+1,i+1),"",200,h*60,(h+1)*60,540,0,180);
     h2_prot_theta_phi_p_sec_fidcut[h][i]= new TH2F(Form("h2_prot_theta_phi_p_sec_fidcut_%d_%i",h+1,i+1),"",200,h*60,(h+1)*60,540,0,180);
 }
 ...
 for(int h=0;h<n_slice;h++){
   ...
   h1_Etot_slice_QE[h]= new TH1F(Form("h1_Etot_slice_QE_%d",h+1),"",n_bins,x_values);
   h1_Erec_slice_QE[h]= new TH1F(Form("h1_Erec_slice_QE_%d",h+1),"",n_bins,x_values);
...
TH1F *Etot_bkgd09_3p1pi  = new TH1F("Etot_bkgd09_3p1pi","",1,0,6);
 ...
 for(int h=0;h<n_slice;h++){
   ...
   h1_Etot_slice_QE[h]->Sumw2();
   h1_Erec_slice_QE[h]->Sumw2();
 }
...
h1_E_rec_43210pi->Sumw2();
 ...
 for(int g=0;g<40;g++){if(abs(p[ind_em]-0.1-g*0.025)<0.025 && sc_sect[sc[ind_em]-1]>0 && sc_sect[sc[ind_em]-1]<7)	h2_el_theta_phi_p_sec_beffidcut[sc_sect[sc[ind_em]-1]-1][g]->Fill(el_phi_mod,el_theta);}
 ...
 if( ec[ind_em] < 0.5 ||  sc[ind_em] < 0.5 ||  cc[ind_em] < 0.5 || q[ind_em] >=0) 
  ...
  if(en_beam[fbeam_en]<3.&& en_beam[fbeam_en]>2    &&(ec[ind_em] < 0.5 || cc[ind_em] < 0.5 ||  sc[ind_em] < 0.5 || q[ind_em] >=0 || ec_ei[ec[ind_em] - 1] < 0.06 || ece/p[ind_em]<fsub_e->Eval(p[ind_em]) || ece/p[ind_em] >fsum_e->Eval(p[ind_em]) || p[ind_em]<min_good_mom || cc_c2[cc[ind_em]-1]>=0.1 || el_sccc_timediff<sc_cc_delt_cut_sect[el_cc_sector-1]  || TMath::Sqrt(p[ind_em]*p[ind_em]+e_mass*e_mass)>en_beam[fbeam_en])) //electron pid cuts
    ...
    h2_el_E_p_ratio_cut->Fill(p[ind_em], ece/p[ind_em]);
      ...
      for(int g=0;g<40;g++){if(abs(p[ind_em]-0.1-g*0.025)<0.025)	h2_el_theta_phi_p_sec_fidcut[sc_sect[sc[ind_em]-1]-1][g]->Fill(el_phi_mod,el_theta);}
    if(sc_paddle==5) {
   ...
   double E_rec=(2*(m_prot-bind_en[ftarget])*V4_el.E()+m_prot*m_prot-(m_prot-bind_en[ftarget])*(m_prot-bind_en[ftarget]))/(2*(m_prot-bind_en[ftarget]-V4_el.E()+V4_el.Rho()*cz[ind_em]));  //using the same value of single nucleon separation E for Ecal and Eqe
    ...
    int ec_index_n[20],ec_index_neutrons[20],index_pipl[20],index_pimi[20];
    bool ec_radstat_n[20]={false};
    int ec_num_n = 0,ec_neutrons=0;
  ...
  for(int g=0;g<80;g++){if(abs(p[ind_p]-0.1-g*0.025)<0.025 && deltt<fsum_prot->Eval(p[ind_p]) && deltt>fsub_prot->Eval(p[ind_p]) )	h2_prot_theta_phi_p_sec_beffidcut[sc_sect[sc[ind_p]-1]-1][g]->Fill(prot_phi,TMath::ACos(cz[ind_p])*TMath::RadToDeg());}	 
	    ...
	    h1_prot_SCpd_sec[sc_sect[sc[ind_p]-1]-1]->Fill(sc_pd[sc[ind_p]-1]);
	    h2_prot_theta_SCpd_sec[sc_sect[sc[ind_p]-1]-1]->Fill(sc_pd[sc[ind_p]-1],TMath::ACos(cz[ind_p])*TMath::RadToDeg());
		...
		if(en_beam[fbeam_en]>2. && en_beam[fbeam_en]<5. && abs(p[ind_p]-0.975)<0.025 && sc_sect[sc[ind_p]-1]==k)   h2_prot_theta_phi_p_fidcut[k-1]->Fill(prot_phi,TMath::ACos(cz[ind_p])*TMath::RadToDeg());
	      ...
	      for(int g=0;g<80;g++){if(abs(p[ind_p]-0.1-g*0.025)<0.025) h2_prot_theta_phi_p_sec_fidcut[sc_sect[sc[ind_p]-1]-1][g]->Fill(prot_phi,TMath::ACos(cz[ind_p])*TMath::RadToDeg());}
	...
	if(q[i]<0 &&  sc[i] > 0 && dc[i]>0 && stat[i] > 0 )
	  {
	    ...
	    if(deltt<fsum_pimi->Eval(p[i]) && deltt>fsub_pimi->Eval(p[i]) && p[i]>chargedpi_accept_mom_lim  ){
  ...
  for(int k=1;k<=6;k++){
	      ...
	      for(int g=0;g<80;g++){
		if(abs(p[i]-0.1-g*0.025)<0.025){
		  h2_pimi_theta_phi_p_sec_beffidcut[sc_sect[sc[i]-1]-1][g]->Fill(pimi_phi_mod,pimi_theta);
		h2_pimi_phi_theta_p_sec_beffidcut[sc_sect[sc[i]-1]-1][g]->Fill(pimi_theta,pimi_phi_mod-60.*(sc_sect[sc[i]-1]-0.5));}
	      }
		h1_pimi_SCpd_sec[sc_sect[sc[i]-1]-1]->Fill(sc_pd[sc[i]-1]);
		...
		for(int g=0;g<80;g++){if(abs(p[i]-0.1-g*0.025)<0.025)	{
		    h2_pimi_theta_phi_p_sec_fidcut[sc_sect[sc[i]-1]-1][g]->Fill(pimi_phi_mod,pimi_theta);
		    h2_pimi_phi_theta_p_sec_fidcut[sc_sect[sc[i]-1]-1][g]->Fill(pimi_theta,pimi_phi_mod-60.*(sc_sect[sc[i]-1]-0.5));}
		}
		if(p[i]<=0.35)	h2_pimi_theta_phi_lowp->Fill(pimi_phi_mod,pimi_theta);
		if(p[i]>0.35)	h2_pimi_theta_phi_highp->Fill(pimi_phi_mod,pimi_theta);
	...
	//	if(q[i]>0 &&  sc[i] > 0 && dc[i]>0 && stat[i] > 0 &&  id[i] == 211)
			if(q[i]>0 &&  sc[i] > 0 && dc[i]>0 && stat[i] > 0)
	  {
	    ...
	    if(deltt<fsum_pipl->Eval(p[i]) && deltt>fsub_pipl->Eval(p[i])  && p[i]>chargedpi_accept_mom_lim){
...
for(int k=1;k<=6;k++){
	    ...
	    for(int g=0;g<40;g++){if(abs(p[i]-0.1-g*0.025)<0.025)	h2_pipl_theta_phi_p_sec_beffidcut[sc_sect[sc[i]-1]-1][g]->Fill(pipl_phi_mod,pipl_theta);}
	    h1_pipl_SCpd_sec[sc_sect[sc[i]-1]-1]->Fill(sc_pd[sc[i]-1]);
	    
	      if (PiplFiducialCut(V3_pipl, &cphil, &cphir)){

		for(int g=0;g<40;g++){if(abs(p[i]-0.1-g*0.025)<0.025)	h2_pipl_theta_phi_p_sec_fidcut[sc_sect[sc[i]-1]-1][g]->Fill(pipl_phi_mod,pipl_theta);}
   ...
   for(int k=1;k<=6;k++){
       	...
       	if(ec[i] > 0 && dc[i]<=0  && sc[i]<=0  && stat[i] > 0 &&  q[i] == 0)
	  {
	    ...
	    if(ec_ei[ec[i] - 1]==0 && ec_eo[ec[i] - 1]>0 && abs(ec_eo[ec[i] - 1]-etot[ec[i] - 1])<0.001*EC_sampling_frac && Phot_fid(V3_phot_angles)){
	      h1_beta_ec_corr_cut->Fill(neut_beta_corr);
	    }
	    if(ec_ei[ec[i] - 1]>0 && ec_eo[ec[i] - 1]==0 && abs(ec_ei[ec[i] - 1]-etot[ec[i] - 1])<0.04*EC_sampling_frac && Phot_fid(V3_phot_angles)) h1_beta_ec_corr_cut1->Fill(neut_beta_corr);
	    if(Phot_fid(V3_phot_angles)) h1_beta_ec_corr1->Fill(neut_beta_corr);
	    h1_beta_ec_corr_sect[ec_sect[ec[i]-1]-1]->Fill(neut_beta_corr);


	    if(neut_beta_corr >EC_photon_beta[ftarget] &&  (photon_ece/EC_sampling_frac)>phot_accept_en_lim){   //photon identification
	      ...
	      h1_ec_u_sect[ec_sect[ec[i]-1]-1]->Fill(v3_phot_ec_uvw.X());
	      h1_ec_v_sect[ec_sect[ec[i]-1]-1]->Fill(v3_phot_ec_uvw.Y());
	      h1_ec_w_sect[ec_sect[ec[i]-1]-1]->Fill(v3_phot_ec_uvw.Z());
...
;
	      if(photon_ece/EC_sampling_frac>1)	  h2_ephotangle_ephotphidiff_cut->Fill(neutr_phi_mod-el_phi_mod,V3_phot_angles.Angle(V4_el.Vect())*TMath::RadToDeg());
	        if(ec_num_n==1) { 
 ...
 if(ec_num_n==0 && num_pi_phot==0 && N_prot_both!=0){
       ...
       h1_pperp->Fill(p_perp_tot_2p[f],-P_N_2p[f]*1/Mott_cross_sec);
       ...
       h2_Q2_nu_weight_sub->Fill(nu,Q2,-P_N_2p[f]*1/Mott_cross_sec);
       h1_Npi_sub->Fill(num_pi,-P_N_2p[f]*1/Mott_cross_sec);
       h1_Q2_weight_sub->Fill(Q2,-P_N_2p[f]*1/Mott_cross_sec);
       ...
       for(int i=0;i<n_slice;i++)
	 {
	   if (p_perp_tot_2p[f]<pperp_max[i] && p_perp_tot_2p[f]>pperp_min[i]){
	    ...
	    if(abs(x_berk-1)<0.2){ 
	      h1_Etot_slice_QE[i]->Fill(E_tot_2p[f],P_N_2p[f]*1/Mott_cross_sec);
	      h1_Erec_slice_QE[i]->Fill(E_rec_new,P_N_2p[f]*1/Mott_cross_sec);
	      h1_Etot_QE->Fill(E_tot_2p[f],P_N_2p[f]*1/Mott_cross_sec);
	      h1_Erec_QE->Fill(E_rec_new,P_N_2p[f]*1/Mott_cross_sec);
	      h1_pperp_QE->Fill(p_perp_tot_2p[f],-P_N_2p[f]*1/Mott_cross_sec);
	    }
	   }
	 }
 ...
 for(int z=0;z<N_2prot;z++){ 
  ...
  h2_Erec_pperp_2p1pi_2p0pi->Fill(p_miss_perp_2p1pi_to2p0pi[z],E_rec_new,P_2p1pito2p0pi[z]*1/Mott_cross_sec);
     ...
     h1_pperp->Fill(p_miss_perp_2p1pi_to2p0pi[z],P_2p1pito2p0pi[z]*1/Mott_cross_sec);
       ...
       h2_Q2_nu_weight_sub->Fill(nu,Q2,P_2p1pito2p0pi[z]*1/Mott_cross_sec);
       h1_Npi_sub->Fill(num_pi,P_2p1pito2p0pi[z]*1/Mott_cross_sec);
       h1_Q2_weight_sub->Fill(Q2,P_2p1pito2p0pi[z]*1/Mott_cross_sec);
	 ...
	 if(abs(x_berk-1)<0.2){ 
	   h1_Etot_slice_QE[i]->Fill(Ecal_2p1pi_to2p0pi[z],P_2p1pito2p0pi[z]*1/Mott_cross_sec);
	   h1_Erec_slice_QE[i]->Fill(E_rec_new,P_2p1pito2p0pi[z]*1/Mott_cross_sec);
	   h1_Etot_QE->Fill(Ecal_2p1pi_to2p0pi[z],P_2p1pito2p0pi[z]*1/Mott_cross_sec);
	   h1_Erec_QE->Fill(E_rec_new,P_2p1pito2p0pi[z]*1/Mott_cross_sec);
	   h1_pperp_QE->Fill(p_miss_perp_2p1pi_to2p0pi[z],P_2p1pito2p0pi[z]*1/Mott_cross_sec);
	 }
       }
     }
     for (int i=0;i<N_pperp;i++){
 ...
 //---------------------------------- 2p 1pi ->1p 1pi   ----------------------------------------------
     ...
     h1_pperp->Fill(p_miss_perp_2p1pi_to2p0pi[z],P_2p1pito1p1pi[z]*1/Mott_cross_sec);
     ...
     h2_Q2_nu_weight_sub->Fill(nu,Q2,P_2p1pito1p1pi[z]*1/Mott_cross_sec);
     h1_Npi_sub->Fill(num_pi,P_2p1pito1p1pi[z]*1/Mott_cross_sec);
     h1_Q2_weight_sub->Fill(Q2,P_2p1pito1p1pi[z]*1/Mott_cross_sec);
   ...
   for(int i=0;i<n_slice;i++){
     if (p_perp_tot_2p[z]<pperp_max[i] && p_perp_tot_2p[z]>pperp_min[i]){
       ...
       if(abs(x_berk-1)<0.2){ 
	 h1_Etot_slice_QE[i]->Fill(E_tot_2p[z],P_2p1pito1p1pi[z]*1/Mott_cross_sec);
	 h1_Erec_slice_QE[i]->Fill(E_rec_new,P_2p1pito1p1pi[z]*1/Mott_cross_sec);
	 h1_Etot_QE->Fill(E_tot_2p[z],P_2p1pito1p1pi[z]*1/Mott_cross_sec);
	 h1_Erec_QE->Fill(E_rec_new,P_2p1pito1p1pi[z]*1/Mott_cross_sec);
	 h1_pperp_QE->Fill(p_miss_perp_2p1pi_to2p0pi[z],P_2p1pito1p1pi[z]*1/Mott_cross_sec);
       }
     }
   }
   for (int i=0;i<N_pperp;i++){
...
//---------------------------------- 2p 1pi ->1p 0pi   ----------------------------------------------
  Etot_2p1pi_1p0pi->Fill(E_tot_2p[z], P_2p1pito1p0pi[z]*1/Mott_cross_sec);
   ...
   h1_pperp->Fill(p_perp_tot_2p[z],-P_2p1pito1p0pi[z]*1/Mott_cross_sec);
   ...
   h2_Q2_nu_weight_sub->Fill(nu,Q2,-P_2p1pito1p0pi[z]*1/Mott_cross_sec);
   h1_Npi_sub->Fill(num_pi,-P_2p1pito1p0pi[z]*1/Mott_cross_sec);
   h1_Q2_weight_sub->Fill(Q2,-P_2p1pito1p0pi[z]*1/Mott_cross_sec);
   ...
   for(int i=0;i<n_slice;i++)
	 ...
	 if(abs(x_berk-1)<0.2){ 
	   h1_Etot_slice_QE[i]->Fill(E_tot_2p[z],-P_2p1pito1p0pi[z]*1/Mott_cross_sec);
	   h1_Erec_slice_QE[i]->Fill(E_rec_new,-P_2p1pito1p0pi[z]*1/Mott_cross_sec);
	   h1_Etot_QE->Fill(E_tot_2p[z],-P_2p1pito1p0pi[z]*1/Mott_cross_sec);
	   h1_Erec_QE->Fill(E_rec_new,-P_2p1pito1p0pi[z]*1/Mott_cross_sec);
	   h1_pperp_QE->Fill(p_perp_tot_2p[z],-P_2p1pito1p0pi[z]*1/Mott_cross_sec);
       }
       }
     }
   for (int i=0;i<N_pperp;i++){
...
for(int z=0;z<N_2prot;z++){ 
  ...
  h1_pperp->Fill(p_perp_tot_2p[z],Ptot_2p[z]*1/Mott_cross_sec);
  ...
  h2_Q2_nu_weight_sub->Fill(nu,Q2,Ptot_2p[z]*1/Mott_cross_sec);
  h1_Npi_sub->Fill(num_pi,Ptot_2p[z]*1/Mott_cross_sec);
  h1_Q2_weight_sub->Fill(Q2,Ptot_2p[z]*1/Mott_cross_sec);
   ...
   for(int i=0;i<n_slice;i++)
	 ...
	 if(abs(x_berk-1)<0.2){ 
	   h1_Etot_slice_QE[i]->Fill(E_tot_2p[z],Ptot_2p[z]*1/Mott_cross_sec);
	   h1_Erec_slice_QE[i]->Fill(E_rec_new,Ptot_2p[z]*1/Mott_cross_sec);
	   h1_Etot_QE->Fill(E_tot_2p[z], Ptot_2p[z]*1/Mott_cross_sec);
	   h1_Erec_QE->Fill(E_rec_new,Ptot_2p[z]*1/Mott_cross_sec);
	   h1_pperp_QE->Fill(p_perp_tot_2p[z],Ptot_2p[z]*1/Mott_cross_sec);
	 }
       }
     }
   for (int i=0;i<N_pperp;i++){
 ...
 //-----------------------------------------  3p to 2p->1p  -----------------------------------------------------------------------
		 ...
		 for(int j=0;j<N_2p;j++)    { 
		   ...
		   h1_pperp->Fill(p_miss_perp_3pto2p[count][j],P_3pto2p[count][j]*1/Mott_cross_sec);
		   ...
		   h2_Q2_nu_weight_sub->Fill(nu,Q2,P_3pto2p[count][j]*1/Mott_cross_sec);
		   h1_Npi_sub->Fill(num_pi,P_3pto2p[count][j]*1/Mott_cross_sec);
		   h1_Q2_weight_sub->Fill(Q2,P_3pto2p[count][j]*1/Mott_cross_sec);
		   ...
		   for(int i=0;i<n_slice;i++)
			 ...
			 if(abs(x_berk-1)<0.2){ 
			   h1_Etot_slice_QE[i]->Fill(E_cal_3pto2p[count][j],P_3pto2p[count][j]*1/Mott_cross_sec);
			   h1_Erec_slice_QE[i]->Fill(E_rec_new,P_3pto2p[count][j]*1/Mott_cross_sec);
			   h1_Etot_QE->Fill(E_cal_3pto2p[count][j], P_3pto2p[count][j]*1/Mott_cross_sec);
			   h1_Erec_QE->Fill(E_rec_new, P_3pto2p[count][j]*1/Mott_cross_sec);
			   h1_pperp_QE->Fill(p_miss_perp_3pto2p[count][j],P_3pto2p[count][j]*1/Mott_cross_sec);
			 }
		       }
		     }
		 }
 ...
 //-----------------------------------------  3p to 1p  -----------------------------------------------------------------------
		 ...
		 h1_pperp->Fill(p_miss_perp[j],-P_3pto1p[j]*1/Mott_cross_sec);
		 ...
		 h2_Q2_nu_weight_sub->Fill(nu,Q2,-P_3pto1p[j]*1/Mott_cross_sec);
		 h1_Npi_sub->Fill(num_pi,-P_3pto1p[j]*1/Mott_cross_sec);
		 h1_Q2_weight_sub->Fill(Q2,-P_3pto1p[j]*1/Mott_cross_sec);
		 ...
		 for(int i=0;i<n_slice;i++)
		   {
		     if (p_miss_perp[j]<pperp_max[i] && p_miss_perp[j]>pperp_min[i]){
		       ...
		       if(abs(x_berk-1)<0.2){ 
			 h1_Etot_slice_QE[i]->Fill(E_cal[j],-P_3pto1p[j]*1/Mott_cross_sec);
			 h1_Erec_slice_QE[i]->Fill(E_rec_new,-P_3pto1p[j]*1/Mott_cross_sec);
			 h1_Etot_QE->Fill(E_cal[j],-P_3pto1p[j]*1/Mott_cross_sec);
			 h1_Erec_QE->Fill(E_rec_new,-P_3pto1p[j]*1/Mott_cross_sec);
			 h1_pperp_QE->Fill(p_miss_perp[j],-P_3pto1p[j]*1/Mott_cross_sec);
		       }
		     }
		   }
 ...
 V3_q=(V4_beam-V4_el).Vect();
   ...
   prot3_pi1_rot_func( V3_q,V3_prot_corr,V3_prot, V3_pi_phot,q[ind_pi_phot[0]],ec_radstat_n[0], V4_el,  Ecal_3p1pi,p_miss_perp_3p1pi, P_tot_3p);
		 ...
		 h1_pperp->Fill(p_miss_perp[j],P_tot_3p[j]*1/Mott_cross_sec);
		 ...
		 h2_Q2_nu_weight_sub->Fill(nu,Q2,P_tot_3p[j]*1/Mott_cross_sec);
		 h1_Npi_sub->Fill(num_pi,P_tot_3p[j]*1/Mott_cross_sec);
		 h1_Q2_weight_sub->Fill(Q2,P_tot_3p[j]*1/Mott_cross_sec);
		 ...
		 for(int i=0;i<n_slice;i++)
		   {
		     if (p_miss_perp[j]<pperp_max[i] && p_miss_perp[j]>pperp_min[i]){
		       ...
		       if(abs(x_berk-1)<0.2){ 
			 h1_Etot_slice_QE[i]->Fill(E_cal[j],P_tot_3p[j]*1/Mott_cross_sec);
			 h1_Erec_slice_QE[i]->Fill(E_rec_new,P_tot_3p[j]*1/Mott_cross_sec);
			 h1_Etot_QE->Fill(E_cal[j], P_tot_3p[j]*1/Mott_cross_sec);
			 h1_Erec_QE->Fill(E_rec_new,P_tot_3p[j]*1/Mott_cross_sec);
			 h1_pperp_QE->Fill(p_miss_perp[j],P_tot_3p[j]*1/Mott_cross_sec);
		       }
		     }
		   }
	   ...
	   //-----------------------------------------  4p to 3p->2->1  -----------------------------------------------------------------------
		     ...
		     for(int j=0;j<N_2p;j++)    {  //looping through number of 1 proton combination out of 2 protons
		       ...
		       h1_pperp->Fill(p_miss_perp_4pto3p[count][j],-P_4pto3p[count][j]*(N_p4_p3[g]/N_p_four)*1/Mott_cross_sec);
		       ...
		       h2_Q2_nu_weight_sub->Fill(nu,Q2,-P_4pto3p[count][j]*(N_p4_p3[g]/N_p_four)*1/Mott_cross_sec);
		       h1_Npi_sub->Fill(num_pi,-P_4pto3p[count][j]*(N_p4_p3[g]/N_p_four)*1/Mott_cross_sec);
		       h1_Q2_weight_sub->Fill(Q2,-P_4pto3p[count][j]*(N_p4_p3[g]/N_p_four)*1/Mott_cross_sec);
		       ...
		       for(int i=0;i<n_slice;i++)
			 {
			   if (p_miss_perp_4pto3p[count][j]<pperp_max[i] && p_miss_perp_4pto3p[count][j]>pperp_min[i]){
			     ...
			     if(abs(x_berk-1)<0.2){ 
			       h1_Etot_slice_QE[i]->Fill(E_cal_4pto3p[count][j],-P_4pto3p[count][j]*(N_p4_p3[g]/N_p_four)*1/Mott_cross_sec);
			       h1_Erec_slice_QE[i]->Fill(E_rec_new,-P_4pto3p[count][j]*(N_p4_p3[g]/N_p_four)*1/Mott_cross_sec);
			       h1_Etot_QE->Fill(E_cal_4pto3p[count][j], -P_4pto3p[count][j]*(N_p4_p3[g]/N_p_four)*1/Mott_cross_sec);
			       h1_Erec_QE->Fill(E_rec_new, -P_4pto3p[count][j]*(N_p4_p3[g]/N_p_four)*1/Mott_cross_sec);
			       h1_pperp_QE->Fill(p_miss_perp_4pto3p[count][j],-P_4pto3p[count][j]*(N_p4_p3[g]/N_p_four)*1/Mott_cross_sec);
			     }
			   }
			 }
		     }
		   ...
		   //-----------------------------------------  4p to 3p->1  -----------------------------------------------------------------------
		     ...
		     h1_pperp->Fill(p_miss_perp_43pto1p[j],P_43pto1p[j]*1/Mott_cross_sec);
		     ...
		     h2_Q2_nu_weight_sub->Fill(nu,Q2,P_43pto1p[j]*1/Mott_cross_sec);
		     h1_Npi_sub->Fill(num_pi,P_43pto1p[j]*1/Mott_cross_sec);
		     h1_Q2_weight_sub->Fill(Q2,P_43pto1p[j]*1/Mott_cross_sec);
			 ...
			 if (p_miss_perp_43pto1p[j]<pperp_max[i] && p_miss_perp_43pto1p[j]>pperp_min[i]){
			   ...
			   if(abs(x_berk-1)<0.2){ 
			     h1_Etot_slice_QE[i]->Fill(E_cal_43pto1p[j],P_43pto1p[j]*1/Mott_cross_sec);
			     h1_Erec_slice_QE[i]->Fill(E_rec_new,P_43pto1p[j]*1/Mott_cross_sec);
			     h1_Etot_QE->Fill(E_cal_43pto1p[j], P_43pto1p[j]*1/Mott_cross_sec);
			     h1_Erec_QE->Fill(E_rec_new,P_43pto1p[j]*1/Mott_cross_sec);
			     h1_pperp_QE->Fill(p_miss_perp_43pto1p[j],P_43pto1p[j]*1/Mott_cross_sec);
			   }
			 }
		       }
  ...
  //-----------------------------------------  4p to 2p->1  -----------------------------------------------------------------------
		 ...
		 for(int ind2=0;ind2<N_p4;ind2++){
		   if(ind1!=ind2 && ind1<ind2){
			 ...
			 h1_pperp->Fill(p_miss_perp_4pto2p[j],P_4pto2p[j]*(N_p4_p2[N_4to2]/N_p_four)*1/Mott_cross_sec);
			 ...
			 h2_Q2_nu_weight_sub->Fill(nu,Q2,P_4pto2p[j]*(N_p4_p2[N_4to2]/N_p_four)*1/Mott_cross_sec);
			 h1_Npi_sub->Fill(num_pi,P_4pto2p[j]*(N_p4_p2[N_4to2]/N_p_four)*1/Mott_cross_sec);
			 h1_Q2_weight_sub->Fill(Q2,P_4pto2p[j]*(N_p4_p2[N_4to2]/N_p_four)*1/Mott_cross_sec);
			 ...
			 for(int i=0;i<n_slice;i++)
			   {
			     if (p_miss_perp_4pto2p[j]<pperp_max[i] && p_miss_perp_4pto2p[j]>pperp_min[i]){
			       ...
			       if(abs(x_berk-1)<0.2){ 
				 h1_Etot_slice_QE[i]->Fill(E_cal_4pto2p[j], P_4pto2p[j]*(N_p4_p2[N_4to2]/N_p_four)*1/Mott_cross_sec);
				 h1_Erec_slice_QE[i]->Fill(E_rec_new, P_4pto2p[j]*(N_p4_p2[N_4to2]/N_p_four)*1/Mott_cross_sec);
				 h1_Etot_QE->Fill(E_cal_4pto2p[j],P_4pto2p[j]*(N_p4_p2[N_4to2]/N_p_four)*1/Mott_cross_sec);
				 h1_Erec_QE->Fill(E_rec_new,P_4pto2p[j]*(N_p4_p2[N_4to2]/N_p_four)*1/Mott_cross_sec);
				 h1_pperp_QE->Fill(p_miss_perp_4pto2p[j],P_4pto2p[j]*(N_p4_p2[N_4to2]/N_p_four)*1/Mott_cross_sec);
			       }
			     }
			   }
		       }
 ...
 //-----------------------------------------  4p to 1p  -----------------------------------------------------------------------
		 ...
		 for(int j=0;j<N_p4;j++)    {       //estimating the undetected 4p contribution to  1p
		   ...
		   h1_pperp->Fill(p_miss_perp_p4[j],-P_4pto1p[j]*1/Mott_cross_sec);
		   ...
		   h2_Q2_nu_weight_sub->Fill(nu,Q2,-P_4pto1p[j]*1/Mott_cross_sec);
		   h1_Npi_sub->Fill(num_pi,-P_4pto1p[j]*1/Mott_cross_sec);
		   h1_Q2_weight_sub->Fill(Q2,-P_4pto1p[j]*1/Mott_cross_sec);
		   ...
		   for(int i=0;i<n_slice;i++)
			 ...
			 if(abs(x_berk-1)<0.2){ 
			   h1_Etot_slice_QE[i]->Fill(E_cal_p4[j],-P_4pto1p[j]*1/Mott_cross_sec);
			   h1_Erec_slice_QE[i]->Fill(E_rec_new,-P_4pto1p[j]*1/Mott_cross_sec);
			   h1_Etot_QE->Fill(E_cal_p4[j],-P_4pto1p[j]*1/Mott_cross_sec);
			   h1_Erec_QE->Fill(E_rec_new,-P_4pto1p[j]*1/Mott_cross_sec);
			   h1_pperp_QE->Fill(p_miss_perp_p4[j],-P_4pto1p[j]*1/Mott_cross_sec);
			 }
		       }
		     }
...
h1_E_rec_43210pi->Fill(E_rec_new,(P_43210pi)*1/Mott_cross_sec);
 ...
 //---------------------------------- 1p 2pi->1p1pi   ----------------------------------------------
   ...
   for(int z=0;z<N_2pi;z++){  //to consider 2 diff. 1pi states
       ...
       h1_pperp->Fill(p_perp_tot,P_1p1pi[z]*1/Mott_cross_sec);
       ...
       h2_Q2_nu_weight_sub->Fill(nu,Q2,P_1p1pi[z]*1/Mott_cross_sec);
       h1_Npi_sub->Fill(num_pi,P_1p1pi[z]*1/Mott_cross_sec);
       h1_Q2_weight_sub->Fill(Q2,P_1p1pi[z]*1/Mott_cross_sec);
	 ...
	 if (p_perp_tot<pperp_max[i] && p_perp_tot>pperp_min[i]){
	   ...
	   if(abs(x_berk-1)<0.2){ 
	     h1_Etot_slice_QE[i]->Fill(E_tot,P_1p1pi[z]*1/Mott_cross_sec);
	     h1_Erec_slice_QE[i]->Fill(E_rec_new,P_1p1pi[z]*1/Mott_cross_sec);
	     h1_Etot_QE->Fill(E_tot,P_1p1pi[z]*1/Mott_cross_sec);
	     h1_Erec_QE->Fill(E_rec_new,P_1p1pi[z]*1/Mott_cross_sec);
	     h1_pperp_QE->Fill(p_perp_tot,P_1p1pi[z]*1/Mott_cross_sec);
	   }
	 }
       }
       for (int i=0;i<N_pperp;i++){
 ...
 //---------------------------------- 1p 2pi->1p0pi   ----------------------------------------------
   ...
   Etot_1p2pi_1p0pi->Fill(E_tot,P_1p0pi*1/Mott_cross_sec);
      ...
      h1_pperp->Fill(p_perp_tot,-P_1p0pi*1/Mott_cross_sec);
      ...
      h2_Q2_nu_weight_sub->Fill(nu,Q2,-P_1p0pi*1/Mott_cross_sec);
      h1_Npi_sub->Fill(num_pi,-P_1p0pi*1/Mott_cross_sec);
      h1_Q2_weight_sub->Fill(Q2,-P_1p0pi*1/Mott_cross_sec);
	...
	if(abs(x_berk-1)<0.2){ 
	  h1_Etot_slice_QE[i]->Fill(E_tot,-P_1p0pi*1/Mott_cross_sec);
	  h1_Erec_slice_QE[i]->Fill(E_rec_new,-P_1p0pi*1/Mott_cross_sec);
	  h1_Etot_QE->Fill(E_tot,-P_1p0pi*1/Mott_cross_sec);
	  h1_Erec_QE->Fill(E_rec_new,-P_1p0pi*1/Mott_cross_sec);
	  h1_pperp_QE->Fill(p_perp_tot,-P_1p0pi*1/Mott_cross_sec);
	}
      }
    }
    for (int i=0;i<N_pperp;i++){
 ...
 if (ec_num_n==0 && num_pi_phot==3) {
   ...
   h1_pperp->Fill(p_perp_tot,P_1p3pi*1/Mott_cross_sec);
   ...
   h2_Q2_nu_weight_sub->Fill(nu,Q2,P_1p3pi*1/Mott_cross_sec);
   h1_Npi_sub->Fill(num_pi,P_1p3pi*1/Mott_cross_sec);
   h1_Q2_weight_sub->Fill(Q2,P_1p3pi*1/Mott_cross_sec);
   ...
   for(int i=0;i<n_slice;i++){
	...
	if(abs(x_berk-1)<0.2){ 
	  h1_Etot_slice_QE[i]->Fill(E_tot,P_1p3pi*1/Mott_cross_sec);
	  h1_Erec_slice_QE[i]->Fill(E_rec_new,P_1p3pi*1/Mott_cross_sec);
	  h1_Etot_QE->Fill(E_tot,P_1p3pi*1/Mott_cross_sec);
	  h1_Erec_QE->Fill(E_rec_new,P_1p3pi*1/Mott_cross_sec);
	  h1_pperp_QE->Fill(p_perp_tot,P_1p3pi*1/Mott_cross_sec);
	}
     }
   }
   for (int i=0;i<N_pperp;i++){
 ...
 if (ec_num_n==0 && num_pi_phot==1) {
	 ...
	 for(int i=0;i<n_slice;i++)
	   {
		 ...
		 if(abs(x_berk-1)<0.2){ 
		   h1_Etot_slice_QE[i]->Fill(E_tot,1/Mott_cross_sec);
		   h1_Erec_slice_QE[i]->Fill(E_rec_new,1/Mott_cross_sec);
		   h1_Etot_QE->Fill(E_tot,1/Mott_cross_sec);
		   h1_Erec_QE->Fill(E_rec_new,1/Mott_cross_sec);
		   h1_pperp_QE->Fill(p_perp_tot,1/Mott_cross_sec);
		 }
	       }	 
		 ...
		 if(N_piphot_det!=0){
		   ...
		   h1_pperp->Fill(p_perp_tot,-(N_piphot_undet/N_piphot_det)*1/Mott_cross_sec);
		   ...
		   h2_Q2_nu_weight_sub->Fill(nu,Q2,-(N_piphot_undet/N_piphot_det)*1/Mott_cross_sec);
		   h1_Npi_sub->Fill(num_pi,-(N_piphot_undet/N_piphot_det)*1/Mott_cross_sec);
		   h1_Q2_weight_sub->Fill(Q2,-(N_piphot_undet/N_piphot_det)*1/Mott_cross_sec);
		
		   if(abs(x_berk-1)<0.2){
		     h1_Etot_QE->Fill(E_tot,-(N_piphot_undet/N_piphot_det)*1/Mott_cross_sec);
		     h1_Erec_QE->Fill(E_rec_new,-(N_piphot_undet/N_piphot_det)*1/Mott_cross_sec);
		     h1_pperp_QE->Fill(p_perp_tot,-(N_piphot_undet/N_piphot_det)*1/Mott_cross_sec);
		     h1_Etot_slice_QE[i]->Fill(E_tot,-(N_piphot_undet/N_piphot_det)*1/Mott_cross_sec);
		     h1_Erec_slice_QE[i]->Fill(E_rec_new,-(N_piphot_undet/N_piphot_det)*1/Mott_cross_sec);
		   }
   ...
   if (ec_num_n==0 && num_pi_phot==0){
	     ...
	     h1_pperp->Fill(p_perp_tot,1/Mott_cross_sec);
	     ...
	     h2_Q2_nu_weight_sub->Fill(nu,Q2,1/Mott_cross_sec);
	     h1_Npi_sub->Fill(num_pi,1/Mott_cross_sec);
	     h1_Q2_weight_sub->Fill(Q2,1/Mott_cross_sec);
